...
let FirstScene = (() => {
    ...
    var FirstScene = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.gameSceneName = (__runInitializers(this, _ageSp_extraInitializers), __runInitializers(this, _gameSceneName_initializers, "mainScene"));
        ...
        onLoad() {
            ...
            //     this.node.getComponent(Canvas).designResolution = size(1280, 720);
            //     this.node.getComponent(Canvas).fitHeight = true;
            //     this.node.getComponent(Canvas).fitHeight = true;
            // } else {
            //     this.node.getComponent(Canvas).designResolution = size(720, 1280);
            //     this.node.getComponent(Canvas).fitWidth = true;
            //     this.node.getComponent(Canvas).fitHeight = false;
            // }
                        ...
                        if (gameAge > 0) {
                            ResUtil_1.default.loadSprite("gx/texture/icon" + gameAge + "/spriteFrame", (err, spriteFrame) => {
                                if (err) {
                                    ...
                                    if (this.ageSp && (0, cc_1.isValid)(this.ageSp)) {
        ...
        enterGame() {
            ...
            console.log("到这了 this.canJumpToNext ： " + this.canJumpToNext);
            if (this.canJumpToNext) {
                ...
                console.log("到这了 this.canJumpToNext else ： " + this.canJumpToNext);
                if (GxConstant_1.default.IS_OPPO_GAME || GxConstant_1.default.IS_QQ_GAME) {
        ...
        jumpScene() {
            cc_1.director.loadScene(this.gameSceneName);
        }
    };
    ...
    (() => {
        ...
        _jkTitle_decorators = [property(cc_1.Label)];
        _jkContent_decorators = [property(cc_1.Label)];
        _jkCompany_decorators = [property(cc_1.Label)];
        _jkSoftCode_decorators = [property(cc_1.Label)];
        _ageSp_decorators = [property(cc_1.Sprite)];
        _gameSceneName_decorators = [property(cc_1.CCString)];
