...
const Gx_TTReward_1 = __importDefault(require("../../prefab/Gx_TTReward"));
...
class BaseGxGame {
    static initPlatform(initCallback) {
        ...
        if (typeof window["qg"] != "undefined") {
            console.log("获取厂商：：", window["qg"].getProvider(), JSON.stringify(window["qg"].getProvider()));
                        ...
                        success: function (res) {
                            ...
                            if (!!logoName) {
                                ...
                                img.onload = function (info) {
                                    ...
                                    GxGame_1.default.LogoSp = new cc_1.SpriteFrame();
                                    GxGame_1.default.LogoSp.texture = texture;
                                };
        ...
        else if (cc_1.sys.os == cc_1.sys.OS.ANDROID && cc_1.sys.isNative) {
        ...
        else if (cc_1.sys.os == cc_1.sys.OS.IOS && cc_1.sys.isNative) {
        ...
        this.initPlatform(() => {
            ...
            if (sysInfo) {
                ...
                if (window["Laya"]) {
                    ...
                    let canvas = cc_1.director.getScene().getChildByName("Canvas");
            ...
            ResUtil_1.default.loadResDir("gx/prefab", cc_1.Prefab)
                .then(() => {
    ...
    static showPrivacyBtnWithParent(parentNode) {
        ...
        let showCallback = () => {
            if (GxGame_1.default.btnPrivacySp) {
                let node = parentNode;
                let addComponent = node.addComponent(cc_1.Sprite);
                addComponent.spriteFrame = GxGame_1.default.btnPrivacySp;
                // node.parent = parentNode;
                node.getComponent(cc_1.UITransform).width = 100;
                node.getComponent(cc_1.UITransform).height = 100;
        ...
        if (GxGame_1.default.btnPrivacySp) {
            ...
            ResUtil_1.default.loadSprite("gx/texture/btn_yinsixieyi/spriteFrame", (err, spriteFrame) => {
                if (err) {
    ...
    static showUserPrivacyBtnWithParent(parentNode) {
        ...
        if (!GxConstant_1.default.IS_QQ_GAME) {
            GxLog_1.default.e("除qq rongyao外 其他渠道不显示 ");
            return;
        }
        if (!GxGame_1.default.needShowAuthorizeBtn()) {
        ...
        if (GxConstant_1.default.IS_RONGYAO_Game) {
            GxLog_1.default.e(" rongyao 渠道不显示 ");
            return;
        }
        if (parentNode == null) {
        ...
        let showCallback = () => {
            if (GxGame_1.default.btnUserSp) {
                let node = parentNode; // new Node();
                let addComponent = node.addComponent(cc_1.Sprite);
                addComponent.spriteFrame = GxGame_1.default.btnUserSp;
                // node.parent = parentNode;
                node.getComponent(cc_1.UITransform).width = 100;
                node.getComponent(cc_1.UITransform).height = 100;
                node.position = (0, cc_1.v3)(0, 0, 0);
                node.on(cc_1.Node.EventType.TOUCH_END, () => {
        ...
        if (GxGame_1.default.btnUserSp) {
            ...
            ResUtil_1.default.loadSprite("gx/texture/btn_fuwuxieyi/spriteFrame", (err, spriteFrame) => {
                if (err) {
    ...
    static showH5GameHallBtnWithParent(parentNode) {
        ...
        if (GxGame_1.default.btnH5HallSp) {
            ...
            ResUtil_1.default.loadSprite("gx/texture/btn_backhall/spriteFrame", (err, spriteFrame) => {
                if (err) {
    ...
    static showH5GameHallBtn(btnPosition = null) {
        ...
        let showCallback = () => {
            if (GxGame_1.default.btnH5HallSp) {
                ...
                let addComponent = node.addComponent(cc_1.Sprite);
                addComponent.spriteFrame = GxGame_1.default.btnH5HallSp;
                node.parent = (0, cc_1.find)("Canvas");
                let winSize = cc_1.view.getVisibleSize();
                node.position = btnPosition
                    ? btnPosition
                    : (0, cc_1.v3)(-(winSize.width / 2 - 100), -110, 0);
                node.getComponent(cc_1.UITransform).width = 100;
                node.getComponent(cc_1.UITransform).height = 100;
                node.on(cc_1.Node.EventType.TOUCH_END, () => {
                    self.onClickBackH5HallBtn();
    ...
    static showTTBoxBtnWithParent(parentNode, rewardCallback, rewardNum, iconAndName) {
                ...
                node.on(cc_1.Node.EventType.TOUCH_END, () => {
                    ...
                    ResUtil_1.default.loadPrefab("gx/prefab/TTReward", (err, prefab) => {
                        ...
                        if (!!GxGame_1.default.uiGroup) {
                            node.layer = GxGame_1.default.uiGroup;
                        }
                        var canvas = (0, cc_1.find)("Canvas");
                        canvas.addChild(node);
                        var nodets = node.getComponent(Gx_TTReward_1.default);
        ...
        if (GxGame_1.default.btnTTBoxSp) {
            ...
            ResUtil_1.default.loadSprite("gx/texture/btn_TTBox/spriteFrame", (err, spriteFrame) => {
                if (err) {
    ...
    static showAddDesktopBtnWithParent(parentNode, callback = null) {
        console.log("showAddDesktopBtnWithParent");
        ...
        if (!this.hasDesktop(null)) {
            ...
            if (GxGame_1.default.btnAddDesktopSp) {
                ...
                ResUtil_1.default.loadSprite("gx/texture/btn_zhuomian/spriteFrame", (err, spriteFrame) => {
                    if (err) {
    ...
    static showMoreGameBtnWithParent(parentNode) {
        ...
        if (GxUtils_1.default.getNativePlatform() == GxEnum_1.PLATFORM.OPPO) {
            ...
            if (GxGame_1.default.btnMoreGameSp) {
                ...
                ResUtil_1.default.loadSprite("gx/texture/gengduo/spriteFrame", (err, spriteFrame) => {
                    if (err) {
    ...
    static showQQShareBtnWithParent(parentNode) {
        if (GxConstant_1.default.IS_QQ_GAME) {
            ...
            if (GxGame_1.default.btnQQShareSp) {
                ...
                ResUtil_1.default.loadSprite("gx/texture/btn_QQShare/spriteFrame", (err, spriteFrame) => {
                    if (err) {
    ...
    static showGameAgeWithParent(parentNode) {
        ...
        if (gameAge > 0) {
            ...
            if (GxGame_1.default.ageSp) {
                ...
                ResUtil_1.default.loadSprite("gx/texture/icon" + gameAge + "/spriteFrame", (err, spriteFrame) => {
                    if (err) {
        ...
        if (gameAge > 0) {
            let showCallback = () => {
                if (GxGame_1.default.ageSp) {
                    ...
                    node.parent = (0, cc_1.find)("Canvas");
                    let winSize = cc_1.view.getVisibleSize();
                    node.position = (0, cc_1.v3)(-(winSize.width / 2 - 100), 100, 0);
                    let self = this;
                    node.getComponent(cc_1.UITransform).width = 100;
                    node.getComponent(cc_1.UITransform).height = 100;
                    node.on(cc_1.Node.EventType.TOUCH_END, () => {
        ...
        if (GxUtils_1.default.getNativePlatform() == GxEnum_1.PLATFORM.OPPO || GxConstant_1.default.IS_QQ_GAME) {
            ...
            let showCallback = () => {
                if (GxGame_1.default.btnMoreGameSp) {
                    ...
                    node.position = btnPosition
                        ? btnPosition
                        : (0, cc_1.v3)(-(winSize.width / 2 - 100), 210, 0);
                    node.getComponent(cc_1.UITransform).width = 100;
                    node.getComponent(cc_1.UITransform).height = 100;
                    node.on(cc_1.Node.EventType.TOUCH_END, () => {
                        self.onClickMoreGameBtn();
    ...
    static Ad() {
        if (GxConstant_1.default.IS_WECHAT_GAME) {
            ...
            return UcAdapter_1.default.getInstance();
        }
        else if (GxConstant_1.default.IS_RONGYAO_Game) {
            return RongYaoAdapter_1.default.getInstance();
        }
        else {
    ...
    static showSubmsgBtnWithParent(parentNode) {
        if (GxConstant_1.default.IS_QQ_GAME || GxConstant_1.default.IS_WECHAT_GAME) {
            ...
            if (GxGame_1.default.btnAddSubmsgSp) {
                ...
                ResUtil_1.default.loadSprite("gx/texture/btn_addsub/spriteFrame", (err, spriteFrame) => {
                    if (err) {
    ...
    static showCancelAccountWithParent(parentNode) {
        ...
        if (GxConstant_1.default.IS_HUAWEI_GAME ||
            ...
            if (GxGame_1.default.btnCancelAccountSp) {
                ...
                ResUtil_1.default.loadSprite("gx/texture/btn_zhuxiao/spriteFrame", (err, spriteFrame) => {
                    if (err) {
