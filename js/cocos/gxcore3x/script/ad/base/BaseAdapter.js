...
const Gx_gameBox_1 = __importDefault(require("../../prefab/Gx_gameBox"));
const Gx_crazypoint_1 = __importDefault(require("../../prefab/Gx_crazypoint"));
const Gx_authorize_1 = __importDefault(require("../../prefab/Gx_authorize"));
const Gx_privacy_1 = __importDefault(require("../../prefab/Gx_privacy"));
const Gx_toast_1 = __importDefault(require("../../prefab/Gx_toast"));
var RECORDER_STATE;
...
class BaseAd {
    ...
    showAuthorize(on_agree, on_refuse) {
        ResUtil_1.default.loadPrefab("gx/prefab/authorize", (err, prefab) => {
            ...
            if (this.authorizeView == null ||
                !(0, cc_1.isValid)(this.authorizeView.node, true)) {
                let node = (0, cc_1.instantiate)(prefab);
                if (!!GxGame_1.default.uiGroup) {
                    node.layer = GxGame_1.default.uiGroup;
                }
                this.authorizeView = node.getComponent(Gx_authorize_1.default);
    ...
    showPrivacy(type = "privacy") {
        ResUtil_1.default.loadPrefab("gx/prefab/privacy", (err, prefab) => {
            if (this.privacyView == null ||
                !(0, cc_1.isValid)(this.privacyView.node, true)) {
                let node = (0, cc_1.instantiate)(prefab);
                if (!!GxGame_1.default.uiGroup) {
                    node.layer = GxGame_1.default.uiGroup;
                }
                this.privacyView = node.getComponent(Gx_privacy_1.default);
    ...
    hideBanner() {
        ...
        if (this.bannerNode &&
            ...
            (0, cc_1.isValid)(this.bannerNode.node, true)) {
    ...
    _videoCallEvent(flag = "", adUnitId = "") {
        ...
        GxGame_1.default.gameEvent("reward", { flag: this.curVideoFlag, adUnitId: adUnitId });
    }
    _videoCompleteEvent() {
    ...
    _videoErrorUploadEvent(reason = "", errCode = "", errMsg = "", adUnitId = "") {
        GxGame_1.default.gameEvent("reward_error_upload", {
            flag: this.curVideoFlag, reason: reason + "",
            errCode: errCode + "",
            errMsg: errMsg + "",
            adUnitId: adUnitId + ""
        });
    ...
    _videoShowEvent(adUnitId = "") {
        GxGame_1.default.gameEvent("reward_show", { flag: this.curVideoFlag, adUnitId: adUnitId + "" });
    }
    /**
     * 上报原生广告曝光
     * @param native_data
    ...
    hideInterstitialNative() {
        if (this.innerInter &&
            ...
            (0, cc_1.isValid)(this.innerInter.node, true)) {
    ...
    hideNativeInterstitial() {
        if (this.nativeInter &&
            ...
            (0, cc_1.isValid)(this.nativeInter.node, true)) {
    ...
    hideNativeIcon() {
        if (this.nativeIcon &&
            ...
            (0, cc_1.isValid)(this.nativeIcon.node, true)) {
     ...
     */
    createToast(desc) {
        if (this.toastView == null || !(0, cc_1.isValid)(this.toastView.node, true)) {
            let node = (0, cc_1.instantiate)(GxUtils_1.default.getRes("gx/prefab/toast", cc_1.Prefab));
            if (!!GxGame_1.default.uiGroup) {
                node.layer = cc_1.Layers.nameToLayer(GxGame_1.default.uiGroup);
            }
            this.toastView = node.getComponent(Gx_toast_1.default);
        }
    ...
    clickNativeInnerInterstitial() {
        ...
        if (this.innerInter && (0, cc_1.isValid)(this.innerInter.node, true)) {
    ...
    showCrazyPoint(on_show, on_close, on_get, is_banner = false) {
        if (GxGame_1.default.gGB("crazy")) {
            cc_1.resources.load("gx/prefab/crazypoint", (err, res) => {
                if (err) {
                    console.log("crazypoint err", err);
                    return;
                }
                let node = (0, cc_1.instantiate)(GxUtils_1.default.getRes("gx/prefab/crazypoint", cc_1.Prefab));
                let crazyPoint = node.getComponent(Gx_crazypoint_1.default);
                node.parent = cc_1.director.getScene().getChildByName("Canvas");
                node.siblingIndex = 32764;
    ...
    showGameBox(on_show, on_close, on_get) {
        if (GxGame_1.default.gGB("z1")) {
            let res = GxUtils_1.default.getRes("gx/prefab/gameBox", cc_1.Prefab);
            let node = (0, cc_1.instantiate)(res);
            let crazyPoint = node.getComponent(Gx_gameBox_1.default);
            node.parent = cc_1.director.getScene().getChildByName("Canvas");
            node.siblingIndex = 32724;
