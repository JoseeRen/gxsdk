...
class QQAdapter extends BaseAdapter_1.default {
    ...
    showAddDesktop(on_close, on_succ) {
        // @ts-ignore
        if (this.addIconNode && this.addIconNode !== undefined && isValid(this.addIconNode.node, true))
            return;
        // @ts-ignore
        let node = instantiate(GxUtils_1.default.getRes("gx/prefab/add_icon", Prefab));
