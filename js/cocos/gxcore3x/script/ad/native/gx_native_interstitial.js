...
let native_interstitial = (() => {
    ...
    var native_interstitial = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.img_bg = (__runInitializers(this, _img_icon_extraInitializers), __runInitializers(this, _img_bg_initializers, null));
            this.btn_check = (__runInitializers(this, _img_bg_extraInitializers), __runInitializers(this, _btn_check_initializers, null));
            this.easy_click = (__runInitializers(this, _btn_check_extraInitializers), __runInitializers(this, _easy_click_initializers, null));
            this.native_node = (__runInitializers(this, _easy_click_extraInitializers), __runInitializers(this, _native_node_initializers, null));
            this.lageBg = (__runInitializers(this, _native_node_extraInitializers), __runInitializers(this, _lageBg_initializers, null));
            this.has_easy_click = __runInitializers(this, _lageBg_extraInitializers);
        }
        start() {
            ...
            this.node.siblingIndex = 10001;
            cc_1.director.once("清除原生", this.hide.bind(this));
        }
        on_click_adv2() {
        ...
        report_click() {
            if (this.native_data) {
                ...
                if (GxGame_1.default.adConfig.canRefresh) {
                    ...
                    if (native_data && (0, cc_1.isValid)(this.node, true)) {
        ...
        on_show() {
            if (GxGame_1.default.Ad().canIn() && this.lageBg) {
                ...
                this.lageBg.on(cc_1.Node.EventType.TOUCH_END, this.on_click_adv, this);
            }
            else {
                this.lageBg.active = false;
            }
            this.native_node.on(cc_1.Node.EventType.TOUCH_END, this.on_click_adv, this);
            this.icon_close.on(cc_1.Node.EventType.TOUCH_END, this.on_click_close, this);
            this.img_bg.node.on(cc_1.Node.EventType.TOUCH_END, this.on_click_adv, this);
            this.btn_check.on(cc_1.Node.EventType.TOUCH_END, this.on_click_adv, this);
            this.easy_click.on(cc_1.Node.EventType.TOUCH_END, this.on_click_adv2, this);
            ...
            if (image_list.length > 0) {
                ...
                ResUtil_1.default.loadRemoteSpiteFrame(url, (err, sp) => {
                    if (!(0, cc_1.isValid)(this.node, true))
                        return;
                    if (err) {
                        return this.img_bg.getComponent(cc_1.Sprite).spriteFrame = null;
                    }
                    this.img_bg.getComponent(cc_1.Sprite).spriteFrame = sp;
                });
                let iconUrl = "";
                if (this.native_data["iconUrlList"] && this.native_data["iconUrlList"].length > 0) {
                ...
                if (!!iconUrl) {
                    this.img_icon.sizeMode = cc_1.Sprite.SizeMode.CUSTOM;
        ...
        on_hide() {
            // this.lageBg.active=true;
            this.lageBg && this.lageBg.active && this.lageBg.on(cc_1.Node.EventType.TOUCH_END, this.on_click_adv, this);
            this.lageBg.active = false;
            this.native_node.off(cc_1.Node.EventType.TOUCH_END, this.on_click_adv, this);
            this.icon_close.off(cc_1.Node.EventType.TOUCH_END, this.on_click_close, this);
            this.img_bg.node.off(cc_1.Node.EventType.TOUCH_END, this.on_click_adv, this);
            this.btn_check.off(cc_1.Node.EventType.TOUCH_END, this.on_click_adv, this);
            this.easy_click.off(cc_1.Node.EventType.TOUCH_END, this.on_click_adv2, this);
             ...
             /!*   if (!GxGame.isShenHe && !GxGame.inBlockArea && GxGame.adConfig.forceClickRto >= 0) {
                    if (GxGame.adConfig.forceClickRto <= 30) {
                        if (view.getVisibleSize().width > view.getVisibleSize().height) {
                            this.easy_click.height = view.getVisibleSize().height;
                            this.easy_click.width = 800;
                        } else {
                            this.easy_click.width = view.getVisibleSize().width;
                            this.easy_click.height = 800;
                        }
                    } else if (GxGame.adConfig.forceClickRto <= 60) {
                        if (view.getVisibleSize().width > view.getVisibleSize().height) {
                            this.easy_click.height = view.getVisibleSize().height;
                            this.easy_click.width = 800 + (view.getVisibleSize().width - 800) / 3;
                        } else {
                            this.easy_click.width = view.getVisibleSize().width;
                            this.easy_click.height = 800 + (view.getVisibleSize().height - 800) / 3;
                        }
                    } else {
                        this.easy_click.height = view.getVisibleSize().height;
                        this.easy_click.width = view.getVisibleSize().width;
        ...
        onDestroy() {
            cc_1.director.off("清除原生", this.hide.bind(this));
            this.hide_back = null;
        }
    };
    ...
    (() => {
        ...
        _img_bg_decorators = [property(cc_1.Sprite)];
        _btn_check_decorators = [property(cc_1.Node)];
        _easy_click_decorators = [property(cc_1.Node)];
        _native_node_decorators = [property(cc_1.Node)];
        _lageBg_decorators = [property(cc_1.Node)];
        ...
        __esDecorate(null, null, _img_bg_decorators, { kind: "field", name: "img_bg", static: false, private: false, access: { has: obj => "img_bg" in obj, get: obj => obj.img_bg, set: (obj, value) => { obj.img_bg = value; } }, metadata: _metadata }, _img_bg_initializers, _img_bg_extraInitializers);
        __esDecorate(null, null, _btn_check_decorators, { kind: "field", name: "btn_check", static: false, private: false, access: { has: obj => "btn_check" in obj, get: obj => obj.btn_check, set: (obj, value) => { obj.btn_check = value; } }, metadata: _metadata }, _btn_check_initializers, _btn_check_extraInitializers);
        __esDecorate(null, null, _easy_click_decorators, { kind: "field", name: "easy_click", static: false, private: false, access: { has: obj => "easy_click" in obj, get: obj => obj.easy_click, set: (obj, value) => { obj.easy_click = value; } }, metadata: _metadata }, _easy_click_initializers, _easy_click_extraInitializers);
        ...
        __esDecorate(null, null, _lageBg_decorators, { kind: "field", name: "lageBg", static: false, private: false, access: { has: obj => "lageBg" in obj, get: obj => obj.lageBg, set: (obj, value) => { obj.lageBg = value; } }, metadata: _metadata }, _lageBg_initializers, _lageBg_extraInitializers);
