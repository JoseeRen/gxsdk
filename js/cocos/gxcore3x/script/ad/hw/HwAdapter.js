...
class HwAdapter extends BaseAdapter_1.default {
    ...
    initAd() {
        ...
        super.initAd();
        cc_1.game.on(cc_1.game.EVENT_HIDE, function () {
            console.log("游戏进入后台");
            cc_1.director.emit("清除原生");
        }, this);
        cc_1.game.on(cc_1.game.EVENT_SHOW, function () {
            console.log("重新返回游戏");
            cc_1.director.emit("清除原生");
        }, this);
        ...
        if (GxAdParams_1.AdParams.hw.appId && GxAdParams_1.AdParams.hw.appId.length > 0) {
            ...
            qg.gameLoginWithReal({
                ...
                fail: function (data, code) {
                    ...
                    node.addComponent(cc_1.Label).string = "重新登录";
