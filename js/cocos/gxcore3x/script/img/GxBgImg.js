...
let ImgNameEnum = (0, cc_1.Enum)(ObjImgName);
let GxBgImg = (() => {
    ...
    var GxBgImg = _classThis = class extends _classSuper {
        ...
        onLoad() {
            this.node.opacity = 0;
            let component = this.node.getComponent(cc_1.Sprite);
            if (!component) {
                component = this.node.addComponent(cc_1.Sprite);
            }
    ...
    (() => {
        ...
        _imgName_decorators = [property({ type: (0, cc_1.Enum)(ImgNameEnum) })];
