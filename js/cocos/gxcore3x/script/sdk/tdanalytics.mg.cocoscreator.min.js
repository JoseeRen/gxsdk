...
function _defineProperties(e, t) { for (var i = 0; i < t.length; i++) {
    var n = t[i];
    n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(e, n.key, n);
} }
function _createClass(e, t, i) { return t && _defineProperties(e.prototype, t), i && _defineProperties(e, i), e; }
var Config = { LIB_VERSION: "3.0.4", LIB_NAME: "MG" }, _ = {}, ArrayProto = Array.prototype, ObjProto = Object.prototype, slice = ArrayProto.slice, nativeToString = ObjProto.toString, nativeHasOwnProperty = Object.prototype.hasOwnProperty, nativeForEach = ArrayProto.forEach, nativeIsArray = Array.isArray, breaker = {}, utmTypes = ["utm_source", "utm_medium", "utm_campaign", "utm_content", "utm_term"];
_.each = function (e, t, i) { if (null == e)
    return !1; if (nativeForEach && e.forEach === nativeForEach)
    e.forEach(t, i);
else if (e.length === +e.length) {
    for (var n = 0, a = e.length; n < a; n++)
        if (n in e && t.call(i, e[n], n, e) === breaker)
            return !1;
}
else
    for (var r in e)
        if (nativeHasOwnProperty.call(e, r) && t.call(i, e[r], r, e) === breaker)
            return !1; }, _.extend = function (i) { return _.each(slice.call(arguments, 1), function (e) { for (var t in e)
    void 0 !== e[t] && (i[t] = e[t]); }), i; }, _.extend2Layers = function (i) { return _.each(slice.call(arguments, 1), function (e) { for (var t in e)
    void 0 !== e[t] && (_.isObject(e[t]) && _.isObject(i[t]) ? _.extend(i[t], e[t]) : i[t] = e[t]); }), i; }, _.isArray = nativeIsArray || function (e) { return "[object Array]" === nativeToString.call(e); }, _.isFunction = function (e) { try {
    return "function" == typeof e;
}
catch (e) {
    return !1;
} }, _.isPromise = function (e) { return "[object Promise]" === nativeToString.call(e) && null != e; }, _.isObject = function (e) { return "[object Object]" === nativeToString.call(e) && null != e; }, _.isEmptyObject = function (e) { if (_.isObject(e)) {
    for (var t in e)
    ...
    return !1;
} return !0; }, _.decodeURIComponent = function (t) { var i = ""; try {
    i = decodeURIComponent(t);
}
catch (e) {
    i = t;
} return i; }, _.encodeURIComponent = function (t) { var i = ""; try {
    i = encodeURIComponent(t);
}
catch (e) {
    i = t;
} return i; }, _.utf8Encode = function (e) { for (var t, i = "", n = t = 0, a = (e = (e + "").replace(/\r\n/g, "\n").replace(/\r/g, "\n")).length, r = 0; r < a; r++) {
    var s = e.charCodeAt(r), o = null;
...
} return n < t && (i += e.substring(n, e.length)), i; }, _.base64Encode = function (e) { var t, i, n, a, r = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", s = 0, o = 0, c = "", u = []; if (!e)
    return e; for (e = _.utf8Encode(e); t = (a = e.charCodeAt(s++) << 16 | e.charCodeAt(s++) << 8 | e.charCodeAt(s++)) >> 18 & 63, i = a >> 12 & 63, n = a >> 6 & 63, a = 63 & a, u[o++] = r.charAt(t) + r.charAt(i) + r.charAt(n) + r.charAt(a), s < e.length;)
    ; switch (c = u.join(""), e.length % 3) {
    case 1:
        c = c.slice(0, -2) + "==";
        break;
    case 2: c = c.slice(0, -1) + "=";
} return c; }, _.encodeDates = function (n) { return _.each(n, function (e, t) { if (_.isDate(e))
    n[t] = _.formatDate(e);
else if (_.isObject(e))
    n[t] = _.encodeDates(e);
else if (_.isArray(e))
    for (var i = 0; i < e.length; i++)
        _.isDate(e[i]) && (n[t][i] = _.formatDate(e[i])); }), n; }, _.formatDate = function (e) { function t(e) { return e < 10 ? "0" + e : e; } return e.getFullYear() + "-" + t(e.getMonth() + 1) + "-" + t(e.getDate()) + " " + t(e.getHours()) + ":" + t(e.getMinutes()) + ":" + t(e.getSeconds()) + "." + ((i = e.getMilliseconds()) < 100 && 9 < i ? "0" + i : i < 10 ? "00" + i : i); var i; }, _.formatTimeZone = function (e, t) { if ("number" != typeof t)
    return e; var i = e.getTime(), e = 6e4 * e.getTimezoneOffset(); return new Date(i + e + 36e5 * t); }, _.getTimeZone = function (e, t) { return "number" == typeof t ? t : 0 - e.getTimezoneOffset() / 60; }, _.searchObjDate = function (i, n) { try {
    (_.isObject(i) || _.isArray(i)) && _.each(i, function (e, t) { _.isObject(e) || _.isArray(e) ? _.searchObjDate(i[t], n) : _.isDate(e) && (i[t] = _.formatDate(_.formatTimeZone(e, n))); });
}
catch (e) {
    logger$1.warn(e);
    ...
    if ("" !== (s = (s = r[u].match(/(.*?)=(.*)/)) || [r[u], r[u], ""])[1].replace(/\s/g, "")) {
        if (s[2] = (n = s[2] || "", _.decodeURIComponent(n.replace(/\+/g, " "))), c === s[1])
            return s[2];
        (i = s[1].match(/(.*)\[([0-9]+)\]/)) ? (o[i[1]] = o[i[1]] || [], o[i[1]][i[2]] = s[2]) : o[s[1]] = s[2];
    } return a === e ? o : o[c]; } return function (e, t) { var i = {}; if ("tld?" === e)
    return a(); if (t = t || window.location.toString(), !e)
    return t; if (e = e.toString(), t.match(/^mailto:([^/].+)/))
    n = t.match(/^mailto:([^/].+)/), i.protocol = "mailto", i.email = n[1];
else {
    if (t.match(/(.*?)\/#!(.*)/) && (t = (n = t.match(/(.*?)\/#!(.*)/))[1] + n[2]), t.match(/(.*?)#(.*)/) && (n = t.match(/(.*?)#(.*)/), i.hash = n[2], t = n[1]), i.hash && e.match(/^#/))
        return s(e, i.hash);
    if (t.match(/(.*?)\?(.*)/) && (n = t.match(/(.*?)\?(.*)/), i.query = n[2], t = n[1]), i.query && e.match(/^\?/))
        return s(e, i.query);
    if (t.match(/(.*?):?\/\/(.*)/) && (n = t.match(/(.*?):?\/\/(.*)/), i.protocol = n[1].toLowerCase(), t = n[2]), t.match(/(.*?)(\/.*)/) && (n = t.match(/(.*?)(\/.*)/), i.path = n[2], t = n[1]), i.path = (i.path || "").replace(/^([^/])/, "/$1").replace(/\/$/, ""), e.match(/^[-0-9]+$/) && (e = e.replace(/^([^/])/, "/$1")), e.match(/^\//))
        return r(e, i.path.substring(1));
    if ((n = (n = r("/-1", i.path.substring(1))) && n.match(/(.*?)\.(.*)/)) && (i.file = n[0], i.filename = n[1], i.fileext = n[2]), t.match(/(.*):([0-9]+)$/) && (n = t.match(/(.*):([0-9]+)$/), i.port = n[2], t = n[1]), t.match(/(.*?)@(.*)/) && (n = t.match(/(.*?)@(.*)/), i.auth = n[1], t = n[2]), i.auth && (n = i.auth.match(/(.*):(.*)/), i.user = n ? n[1] : i.auth, i.pass = n ? n[2] : void 0), i.hostname = t.toLowerCase(), "." === e.charAt(0))
        return r(e, i.hostname);
    a() && (n = i.hostname.match(a())) && (i.tld = n[3], i.domain = n[2] ? n[2] + "." + n[3] : void 0, i.sub = n[1] || void 0);
    var n = i.port ? ":" + i.port : "";
    i.protocol = i.protocol || window.location.protocol.replace(":", ""), i.port = i.port || ("https" === i.protocol ? "443" : "80"), i.protocol = i.protocol || ("443" === i.port ? "https" : "http"), i.basic = i.protocol + "://" + i.hostname + n;
} return e in i ? i[e] : "{}" === e ? i : ""; }; }(), _.createString = function (e) { for (var t = e, i = Math.random().toString(36).substr(2); i.length < t;)
    i += Math.random().toString(36).substr(2); return i = i.substr(0, e); }, _.createAesKey = function () { return _.createString(16); }, _.generateEncryptyData = function (e, t) { if (void 0 === t)
    return e; var i = t.publicKey, n = t.version; if (void 0 === i || void 0 === n)
    return e; if ("undefined" == typeof CryptoJS || "undefined" == typeof JSEncrypt)
    return e; var a = _.createAesKey(); try {
    var r = CryptoJS.enc.Utf8.parse(a), s = CryptoJS.enc.Utf8.parse(JSON.stringify(e)), o = _.isUndefined(CryptoJS.pad.Pkcs7) ? CryptoJS.pad.PKCS7 : CryptoJS.pad.Pkcs7, r = CryptoJS.AES.encrypt(s, r, { mode: CryptoJS.mode.ECB, padding: o }).toString(), o = new JSEncrypt;
    o.setPublicKey(i);
    o = o.encrypt(a);
    return !1 === o ? (logger$1.warn("Encryption failed, return the original data"), e) : { pkv: n, ekey: o, payload: r };
}
catch (e) {
    logger$1.warn("Encryption failed, return the original data: " + e);
} return e; }, _.getUtm = function () { var i = {}; return _.each(utmTypes, function (e) { try {
    var t = _.getQueryParam(location.href, e);
    t.length && (i[e] = t);
}
catch (e) {
    logger$1.warn("get utm fail: " + e);
} }), JSON.stringify(i); }, _.getQueryParam = function (e, t) { t = t.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]"), e = _.decodeURIComponent(e); e = new RegExp("[\\?&]" + t + "=([^&#]*)").exec(e); return null === e || e && "string" != typeof e[1] && e[1].length ? "" : _.decodeURIComponent(e[1]); }, _.getUtmFromQuery = function (t) { var i = {}; return _.each(utmTypes, function (e) { t[e] && (i[e] = t[e]); }), JSON.stringify(i); }, _.indexOf = function (e, t) { var i = e.indexOf; if (i)
    return i.call(e, t); for (var n = 0; n < e.length; n++)
    if (t === e[n])
        return n; return -1; }, _.checkCalibration = function (e, t, i) { return e; };
var logger$1 = "object" === _typeof(logger$1) ? logger$1 : {};
logger$1.info = function () { if ("object" === ("undefined" == typeof console ? "undefined" : _typeof(console)) && console.log && logger$1.enabled)
    try {
    ...
    } }, logger$1.warn = function () { if ("object" === ("undefined" == typeof console ? "undefined" : _typeof(console)) && console.log && logger$1.enabled)
    try {
...
var PlatformProxy = function () { function e() { _classCallCheck(this, e), this.config = { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_mg" }; } return _createClass(e, [{ key: "initSdkConfig", value: function (e) { this.initConfig = e; } }, { key: "getConfig", value: function () { return this.config; } }, { key: "getStorage", value: function (e, t, i) { e = localStorage.getItem(e); if (!t)
            ...
            case "wechat_mp": return new n(wx, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_wechat", plat: "wx" }, { mpPlatform: "wechat", mp: !0, platform: e });
            case "wechat_mg": return new n(wx, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_wechat_game", plat: "wx" }, { mpPlatform: "wechat", platform: e });
            case "qq_mp": return new n(qq, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_qq" }, { mpPlatform: "qq", mp: !0, platform: e });
            case "qq_mg": return new n(qq, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_qq_game" }, { mpPlatform: "qq", platform: e });
            case "baidu_mp": return new n(swan, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_swan" }, { mpPlatform: function (e) { return e.host; }, mp: !0, platform: e });
            case "baidu_mg": return new n(swan, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_swan_game" }, { mpPlatform: function (e) { return e.host; }, platform: e });
            case "tt_mg": return new n(tt, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_tt_game" }, { mpPlatform: function (e) { return e.appName; }, platform: e });
            case "tt_mp": return new n(tt, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_tt" }, { mpPlatform: function (e) { return e.appName; }, mp: !0, platform: e });
            case "ali_mp": return new n(my, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_ali" }, { mpPlatform: function (e) { return e.app; }, mp: !0, platform: e });
            case "ali_mg": return new n(my, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_ali_game" }, { mpPlatform: function (e) { return e.app; }, platform: e });
            case "dd_mp": return new n(dd, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_dd" }, { mpPlatform: "dingding", mp: !0, platform: e });
            case "bl_mg": return new n(bl, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_mg" }, { mpPlatform: "bilibili", platform: e });
            case "kuaishou_mp": return new n(ks, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_kuaishou" }, { mpPlatform: "kuaishou", mp: !0, platform: e });
            case "kuaishou_mg": return new n(ks, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_kuaishou" }, { mpPlatform: "kuaishou", platform: e });
            case "qh360_mg": return new n(qh, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_qh360" }, { mpPlatform: "qh360", platform: e });
            case "tb_mp": return new n(my, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_tb" }, { mpPlatform: "tb", mp: !0, platform: e });
            case "jd_mp": return new n(jd, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_jd" }, { mpPlatform: "jd", mp: !0, platform: e });
            case "qh360_mp": return new n(qh, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_qh360" }, { mpPlatform: "qh360", mp: !0, platform: e });
            case "WEB": return new PlatformProxy.createInstance;
        } } }]), n; }(), AutoTrackBridge$2 = function e(t, i) { var n = this; _classCallCheck(this, e), this.taInstance = t, this.config = i || {}, this.config.appShow && this.taInstance._internalTrack("ta_mg_show"), this.config.appHide && this.taInstance.timeEvent("ta_mg_hide"), qg.onShow(function () { var e; n.config.appHide && n.taInstance.timeEvent("ta_mg_hide"), n.config.appShow && (e = {}, _.extend(e, n.config.properties), _.isFunction(n.config.callback) && _.extend(e, n.config.callback("appShow")), n.taInstance._internalTrack("ta_mg_show")); }), qg.onHide(function () { var e; n.config.appHide && (e = {}, _.extend(e, n.config.properties), _.isFunction(n.config.callback) && _.extend(e, n.config.callback("appHide")), n.taInstance._internalTrack("ta_mg_hide")); }); }, PlatformProxy$2 = function () { function e() { _classCallCheck(this, e), this.config = { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_qg_vivo_game", asyncPersistence: !0 }; } return _createClass(e, [{ key: "initSdkConfig", value: function (e) { this.initConfig = e; } }, { key: "getConfig", value: function () { return this.config || {}; } }, { key: "getStorage", value: function (e, t, i) { if (!t) {
            t = qg.getStorageSync({ key: e });
            return _.isJSONString(t) ? JSON.parse(t) : {};
        } qg.getStorage({ key: e, success: function (e) { e = _.isJSONString(e) ? JSON.parse(e) : {}; i(e); }, fail: function () { i({}); } }); } }, { key: "setStorage", value: function (e, t) { qg.setStorage({ key: e, value: t }); } }, { key: "removeStorage", value: function (e) { qg.deleteStorage({ key: e }); } }, { key: "getSystemInfo", value: function (n) { qg.getSystemInfo({ success: function (e) { var t = e, i = [e.osType, e.osVersionName].join(" "); t.brand = e.manufacturer, t.system = i, t.mp_platform = "vivo_qg", n.success(t); }, complete: function () { n.complete(); } }); } }, { key: "getNetworkType", value: function (i) { qg.getNetworkType({ success: function (e) { var t = e; t.networkType = e.type, i.success(t); }, complete: function () { i.complete(); } }); } }, { key: "onNetworkStatusChange", value: function (i) { qg.subscribeNetworkStatus({ callback: function (e) { var t = e; t.networkType = e.type, i(t); } }); } }, { key: "request", value: function (t) { return qg.request({ url: t.url, data: t.data, method: t.method, header: t.header, success: function (e) { t.success(e); }, fail: function (e) { t.fail(e); } }); } }, { key: "initAutoTrackInstance", value: function (e, t) { return new AutoTrackBridge$2(e, t.autoTrack); } }, { key: "setGlobal", value: function (e, t) { globalThis[t] = e; } }, { key: "getAppOptions", value: function () { return {}; } }, { key: "showToast", value: function (e) { qg.showToast({ message: e, duration: 0 }); } }], [{ key: "createInstance", value: function () { return new e; } }]), e; }(), AutoTrackBridge$3 = function e(t, i, n) { var a = this; _classCallCheck(this, e), this.taInstance = t, this.config = i || {}, this.config.appShow && (i = {}, _.extend(i, this.config.properties), _.isFunction(this.config.callback) && _.extend(i, this.config.callback("appShow")), this.taInstance._internalTrack("ta_mg_show", i)), this.config.appHide && this.taInstance.timeEvent("ta_mg_hide"), n.onShow(function () { var e; a.config.appHide && a.taInstance.timeEvent("ta_mg_hide"), a.config.appShow && (e = {}, _.extend(e, a.config.properties), _.isFunction(a.config.callback) && _.extend(e, a.config.callback("appShow")), a.taInstance._internalTrack("ta_mg_show", e)); }), n.onHide(function () { var e; a.config.appHide && (e = {}, _.extend(e, a.config.properties), _.isFunction(a.config.callback) && _.extend(e, a.config.callback("appHide")), a.taInstance._internalTrack("ta_mg_hide", e)); }); }, PlatformProxy$3 = function () { function n(e, t, i) { _classCallCheck(this, n), this.api = e, this.config = t, this._config = i; } return _createClass(n, [{ key: "initSdkConfig", value: function (e) { this.initConfig = e; } }, { key: "getConfig", value: function () { return this.config || {}; } }, { key: "getStorage", value: function (e, t, i) { e = localStorage.getItem(e); if (!t)
            ...
            case "oppo": return new n(qg, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_qg_oppo_game" }, { mpPlatform: "oppo_qg" });
            case "huawei": return new n(hbs, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_qg_huawei_game" }, { mpPlatform: "huawei_qg" });
            case "mz": return new n(qg, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_qg_mz_game" }, { mpPlatform: "mz" });
            case "xiaomi": return new n(qg, { persistenceName: "thinkingdata", persistenceNameOld: "thinkingdata_qg" }, { mpPlatform: "xiaomi" });
        } } }]), n; }(), PlatformProxyCC = function () { function e() { _classCallCheck(this, e); } return _createClass(e, null, [{ key: "createInstance", value: function () { var e = Object.freeze({ WECHAT_GAME: 104, QQ_PLAY: 105, BAIDU_GAME: 107, VIVO_GAME: 108, OPPO_GAME: 109, HUAWEI_GAME: 110, XIAOMI_GAME: 111, BYTEDANCE_GAME: 117, QTT_GAME: 116, LINKSURE: 119, ALI_GAME: 113, WECHAT_MINI_GAME: "WECHAT_GAME", BAIDU_MINI_GAME: "BAIDU_MINI_GAME", XIAOMI_QUICK_GAME: "XIAOMI_QUICK_GAME", OPPO_MINI_GAME: "OPPO_MINI_GAME", VIVO_MINI_GAME: "VIVO_MINI_GAME", HUAWEI_QUICK_GAME: "HUAWEI_QUICK_GAME", BYTEDANCE_MINI_GAME: "BYTEDANCE_MINI_GAME", QTT_MINI_GAME: "QTT_MINI_GAME", LINKSURE_MINI_GAME: "LINKSURE_MINI_GAME", ALIPAY_MINI_GAME: "ALIPAY_MINI_GAME" }); if (cc.sys.platform === e.WECHAT_GAME || cc.sys.platform === e.WECHAT_MINI_GAME)
            return PlatformProxy$1._createInstance("wechat_mg"); if (cc.sys.platform === e.BAIDU_GAME || cc.sys.platform === e.BAIDU_MIN_GAME)
            return PlatformProxy$1._createInstance("baidu_mg"); if (cc.sys.platform === e.VIVO_GAME || cc.sys.platform === e.VIVO_MINI_GAME)
            return PlatformProxy$2.createInstance(); if (cc.sys.platform === e.QQ_PLAY)
            return PlatformProxy$1._createInstance("qq_mg"); if (cc.sys.platform === e.OPPO_GAME || cc.sys.platform === e.OPPO_MINI_GAME)
            return PlatformProxy$3._createInstance("oppo"); if (cc.sys.platform === e.HUAWEI_GAME || cc.sys.platform === e.HUAWEI_QUICK_GAME)
            return PlatformProxy$3._createInstance("huawei"); if (cc.sys.platform === e.XIAOMI_GAME || cc.sys.platform === e.XIAOMI_QUICK_GAME)
            return PlatformProxy$3._createInstance("xiaomi"); if (cc.sys.platform === e.BYTEDANCE_GAME || cc.sys.platform === e.BYTEDANCE_MINI_GAME)
            return PlatformProxy$1._createInstance("tt_mg"); if (cc.sys.platform === e.ALI_GAME || cc.sys.platform === e.ALIPAY_MINI_GAME)
            return PlatformProxy$1._createInstance("ali_mg"); var i = PlatformProxy.createInstance(); return i._sysCallback = function () { return { system: cc.sys.os.replace(" ", "") + " " + cc.sys.osVersion }; }, i.getNetworkType = function (e) { var t = {}; switch (cc.sys.getNetworkType()) {
            ...
            if (_.isObject(e) && 200 === e.statusCode) {
                ...
                switch ((_.isUndefined(e.data) || _.isUndefined(e.data.code)) && (e.data = { code: 0 }), e.data.code) {
                    ...
                    case -5:
                        t = "server error";
                        break;
                    default: t = "Unknown return code";
                }
                this.callback({ code: e.data.code, msg: t });
            }
            else
                this.callback({ code: -3, msg: _.isObject(e) ? e.statusCode : "Unknown error" }); } }, { key: "onFailed", value: function (e) { this.sendTimeout() || (0 < --this.tryCount ? this.run() : this.callback({ code: -3, msg: _.isObject(e) ? e.errMsg : "Unknown error" })); } }, { key: "sendTimeout", value: function () { return (new Date).getTime() - this.runTime.getTime() > this.timeout; } }]), r; }(), HttpTaskDebug = function () { function o(e, t, i, n, a, r, s) { _classCallCheck(this, o), this.data = e, this.serverDebugUrl = t, this.callback = s, this.tryCount = _.isNumber(i) ? i : 1, this.timeout = _.isNumber(n) ? n : 5e3, this.dryrun = a, this.deviceId = r, this.taClassName = "HttpTaskDebug"; } return _createClass(o, [{ key: "run", value: function () { var t = this, e = "appid=" + this.data["#app_id"] + "&source=client&dryRun=" + this.dryrun + "&deviceId=" + this.deviceId + "&data=" + encodeURIComponent(JSON.stringify(this.data.data[0])), i = _.createExtraHeaders(); i["content-type"] = "application/x-www-form-urlencoded"; var n = PlatformAPI.request({ url: this.serverDebugUrl, method: "POST", data: e, header: i, success: function (e) { t.onSuccess(e), clearTimeout(a); }, fail: function (e) { t.onFailed(e), clearTimeout(a); } }), a = setTimeout(function () { (_.isObject(n) || _.isPromise(n)) && _.isFunction(n.abort) && n.abort(); }, this.timeout); } }, { key: "onSuccess", value: function (e) { if (_.isObject(e) && 200 === e.statusCode) {
            var t;
            if ((_.isUndefined(e.data) || _.isUndefined(e.data.errorLevel)) && (e.data = { errorLevel: 0 }), 0 === e.data.errorLevel)
                t = "Verify data success.";
            else if (1 === e.data.errorLevel) {
                for (var i = e.data.errorProperties, n = "", a = 0; a < i.length; a++)
                    var r = i[a].errorReason, n = n + " propertyName:" + i[a].propertyName + " errorReasons:" + r + "\n";
            ...
            this.callback({ code: -3, msg: _.isObject(e) ? e.statusCode : "Unknown error" }); } }, { key: "onFailed", value: function (e) { 0 < --this.tryCount ? this.run() : this.callback({ code: -3, msg: _.isObject(e) ? e.errMsg : "Unknown error" }); } }]), o; }(), SenderQueue = function () { function e() { _classCallCheck(this, e), this.items = [], this.isRunning = !1, this.showDebug = !1; } return _createClass(e, [{ key: "enqueue", value: function (e, t, i, n) { var a = this, n = !(3 < arguments.length && void 0 !== n) || n, r = this, t = "debug" === i.debugMode ? new HttpTaskDebug(e, t, i.maxRetries, i.sendTimeout, 0, i.deviceId, function (e) { r.isRunning = !1, delete a.runTime, _.isFunction(i.callback) && i.callback(e), r._runNext(), !1 === r.showDebug && (0 !== e.code && 1 !== e.code && 2 !== e.code || (r.showDebug = !0, _.isFunction(PlatformAPI.showDebugToast) && PlatformAPI.showDebugToast("The current mode is Debug"))); }) : "debugOnly" === i.debugMode ? new HttpTaskDebug(e, t, i.maxRetries, i.sendTimeout, 1, i.deviceId, function (e) { r.isRunning = !1, delete a.runTime, _.isFunction(i.callback) && i.callback(e), r._runNext(), !1 === r.showDebug && (0 !== e.code && 1 !== e.code && 2 !== e.code || (r.showDebug = !0, _.isFunction(PlatformAPI.showDebugToast) && PlatformAPI.showDebugToast("The current mode is debugOnly"))); }) : new HttpTask(JSON.stringify(e), t, i.maxRetries, i.sendTimeout, function (e) { r.isRunning = !1, delete a.runTime, _.isFunction(i.callback) && i.callback(e), r._runNext(); }); !0 === n ? (this.items.push(t), this._runNext()) : t.run(); } }, { key: "_dequeue", value: function () { return this.items.shift(); } }, { key: "_runNext", value: function () { if (0 < this.items.length && !this.isRunning)
            if (this.isRunning = !0, this.runTime = new Date, "HttpTask" !== this.items[0].taClassName)
                this._dequeue().run();
            else {
                var e = this.items.splice(0, this.items.length), t = e[0], i = JSON.parse(t.data), n = i["#app_id"], a = [];
                a.push(t.callback);
                for (var r = 1; r < e.length; r++) {
                    var s = e[r], o = JSON.parse(s.data);
                    o["#app_id"] === n && t.serverUrl === s.serverUrl ? (i.data = i.data.concat(o.data), a.push(s.callback)) : this.items.push(s);
                }
                var c = (new Date).getTime();
                i["#flush_time"] = c, new HttpTask(JSON.stringify(i), t.serverUrl, t.tryCount, t.timeout, function (e) { for (var t in a)
                    Object.hasOwnProperty.call(a, t) && (0, a[t])(e); }).run();
            } } }, { key: "runTimeout", value: function (e) { if (_.isDate(this.runTime) && (new Date).getTime() - this.runTime.getTime() > e)
            return !0; return !1; } }, { key: "resetTimeout", value: function () { this.isRunning = !1, delete this.runTime; } }]), e; }(), senderQueue = new SenderQueue, DEFAULT_CONFIG = { name: "thinkingdata", is_plugin: !1, maxRetries: 3, sendTimeout: 5e3, enablePersistence: !0, asyncPersistence: !1, enableLog: !0, strict: !1, debugMode: "none", enableCalibrationTime: !1, enableBatch: !1, cloudEnv: "online", reportingToTencentSdk: 3, canReport: 1, autoTrack: { appLaunch: !0, appShow: !0, appHide: !0 } }, systemInformation = { properties: { "#lib": Config.LIB_NAME, "#lib_version": Config.LIB_VERSION }, initDeviceId: function (e) { _.isString(e) && (this.properties["#device_id"] = e); }, getSystemInfo: function (e) { var i = this; PlatformAPI.onNetworkStatusChange(function (e) { i.properties["#network_type"] = e.networkType; }), PlatformAPI.getNetworkType({ success: function (e) { i.properties["#network_type"] = e.networkType; }, complete: function () { PlatformAPI.getSystemInfo({ success: function (e) { var t = e.system ? e.system.replace(/\s+/g, " ").split(" ") : [], t = { "#manufacturer": e.brand, "#device_model": e.model, "#screen_width": Number(e.screenWidth), "#screen_height": Number(e.screenHeight), "#os": t[0], "#os_version": t[1], "#mp_platform": e.mp_platform, "#system_language": e.systemLanguage }; _.extend(i.properties, t), _.setMpPlatform(e.mp_platform); }, complete: function () { e(); } }); } }); } }, ThinkingDataPersistence = function () { function e(t, i) { var n = this; _classCallCheck(this, e), this.enabled = t.enablePersistence, this.enabled ? (t.isChildInstance ? (this.name = t.persistenceName + "_" + t.name, this.nameOld = t.persistenceNameOld + "_" + t.name) : (this.name = t.persistenceName, this.nameOld = t.persistenceNameOld), t.asyncPersistence ? (this._state = {}, PlatformAPI.getStorage(this.name, !0, function (e) { _.isEmptyObject(e) ? PlatformAPI.getStorage(n.nameOld, !0, function (e) { n._state = _.extend2Layers({}, e, n._state), n._init(t, i), n._save(); }) : (n._state = _.extend2Layers({}, e, n._state), n._init(t, i), n._save()); })) : (this._state = PlatformAPI.getStorage(this.name) || {}, _.isEmptyObject(this._state) && (this._state = PlatformAPI.getStorage(this.nameOld) || {}), this._init(t, i))) : (this._state = {}, this._init(t, i)); } return _createClass(e, [{ key: "_init", value: function (e, t) { this.getDistinctId() || this.setDistinctId(_.UUID()), e.isChildInstance || (this.getDeviceId() || this._setDeviceId(_.UUID()), systemInformation.initDeviceId(this.getDeviceId())), this.initComplete = !0, "function" == typeof t && t(), this._save(); } }, { key: "_save", value: function () { this.enabled && this.initComplete && PlatformAPI.setStorage(this.name, JSON.stringify(this._state)); } }, { key: "_set", value: function (e, t) { var i, n = this; "string" == typeof e ? (i = {})[e] = t : "object" === _typeof(e) && (i = e), _.each(i, function (e, t) { n._state[t] = e; }), this._save(); } }, { key: "_get", value: function (e) { return this._state[e]; } }, { key: "setEventTimer", value: function (e, t) { var i = this._state.event_timers || {}; i[e] = t, this._set("event_timers", i); } }, { key: "removeEventTimer", value: function (e) { var t = (this._state.event_timers || {})[e]; return _.isUndefined(t) || (delete this._state.event_timers[e], this._save()), t; } }, { key: "getDeviceId", value: function () { return this._state.device_id; } }, { key: "_setDeviceId", value: function (e) { this.getDeviceId() ? logger$1.warn("cannot modify the device id.") : this._set("device_id", e); } }, { key: "getDistinctId", value: function () { return this._state.distinct_id; } }, { key: "setDistinctId", value: function (e) { this._set("distinct_id", e); } }, { key: "getAccountId", value: function () { return this._state.account_id; } }, { key: "setAccountId", value: function (e) { this._set("account_id", e); } }, { key: "getSuperProperties", value: function () { return this._state.props || {}; } }, { key: "setSuperProperties", value: function (e, t) { e = t ? e : _.extend(this.getSuperProperties(), e); this._set("props", e); } }]), e; }(), dataStoragePrefix = "ta_mpsdk_", tabStoragePrefix = "tab_tampsdk_", BatchConsumer = function () { function r(e, t) { _classCallCheck(this, r), this.config = e, this.ta = t, this.timer = null, this.batchConfig = _.extend({ size: 6, interval: 6e3, maxLimit: 500 }, this.config.batchConfig), this.batchConfig.size < 1 && (this.batchConfig.size = 1), 30 < this.batchConfig.size && (this.batchConfig.size = 30), this.storageKey = dataStoragePrefix + this.config.appId, this.maxLimit = this.batchConfig.maxLimit, this.batchList = []; t = PlatformAPI.getStorage(this.storageKey); _.isArray(t) && (this.batchList = t); var t = tabStoragePrefix + this.config.appId, i = PlatformAPI.getStorage(t); if (_.isArray(i)) {
    for (var n = 0; n < i.length; n++) {
        var a = PlatformAPI.getStorage(i[n]);
        this.batchList.push(a), PlatformAPI.removeStorage(i[n]);
    }
    PlatformAPI.removeStorage(t);
} this.dataHasChange = !1, this.dataSendTimeStamp = 0; } return _createClass(r, [{ key: "batchInterval", value: function () { this.loopWrite(), this.loopSend(); } }, { key: "loopWrite", value: function () { var e = this; setTimeout(function () { e.batchWrite(), e.loopWrite(); }, 500); } }, { key: "batchWrite", value: function () { this.dataHasChange && (this.dataHasChange = !1, PlatformAPI.setStorage(this.storageKey, JSON.stringify(this.batchList))); } }, { key: "loopSend", value: function () { var e = this; e.timer = setTimeout(function () { e.batchSend(), clearTimeout(e.timer), e.loopSend(); }, this.batchConfig.interval); } }, { key: "add", value: function (e) { this.batchList.length > this.maxLimit && this.batchList.shift(), this.batchList.push(e), this.dataHasChange = !0, this.batchList.length > this.batchConfig.size && this.batchSend(); } }, { key: "flush", value: function () { clearTimeout(this.timer), this.batchSend(), this.loopSend(); } }, { key: "batchSend", value: function () { var t, i, n, e = new Date; 0 !== this.dataSendTimeStamp && e.getTime() - this.dataSendTimeStamp < this.config.sendTimeout + 500 || (this.dataSendTimeStamp = e.getTime(), 0 < (t = (e = 30 < this.batchList.length ? this.batchList.slice(0, 30) : this.batchList).length) && ((i = {}).data = e, i["#app_id"] = this.config.appId, i["#flush_time"] = (new Date).getTime(), n = this, senderQueue.enqueue(i, this.ta.serverUrl, { maxRetries: 1, sendTimeout: this.config.sendTimeout, callback: function (e) { 0 === e.code && (logger$1.info("Flush success: " + JSON.stringify(i, null, 4)), n.batchRemove(t)); }, debugMode: this.config.debugMode, deviceId: this.ta.getDeviceId() }, !1))); } }, { key: "batchRemove", value: function (e) { this.dataSendTimeStamp = 0, this.batchList.splice(0, e), this.dataHasChange = !0, this.batchWrite(); } }]), r; }(), ThinkingDataAPI = function () { function n(e) { if (_classCallCheck(this, n), e)
    if (e.accountId) {
        !PlatformAPI.isWxPlat() || 1 !== e.reportingToTencentSdk && 2 !== e.reportingToTencentSdk || (t = e.tgaInitParams.tgaSDK, e.tgaInitParams && t && ("debug" !== e.debugMode && "debugOnly" !== e.debugMode || t.setDebug(!0), this.wxSdk = new t({ user_action_set_id: e.tgaInitParams.user_action_set_id, secret_key: e.tgaInitParams.secret_key, appid: e.tgaInitParams.appid }), e.tgaInitParams.openId ? this.wxSdk.setOpenId(e.tgaInitParams.openId) : e.tgaInitParams.unionId && this.wxSdk.setUnionId(e.tgaInitParams.unionId))), this.isTADisable = 1 === e.reportingToTencentSdk, e.appId = e.appId ? _.checkAppId(e.appId) : _.checkAppId(e.appid), e.serverUrl = e.serverUrl ? _.checkUrl(e.serverUrl) : _.checkUrl(e.server_url);
        var t = _.extend({}, DEFAULT_CONFIG, PlatformAPI.getConfig());
        _.isObject(e) ? (this.config = _.extend(t, e), e.autoTrack && (this.config.autoTrack = _.extend(DEFAULT_CONFIG.autoTrack, e.autoTrack))) : this.config = t, this._init(this.config);
    }
    else
        for (var i = 0; i < 10; i++)
            setTimeout(function () { console.error("初始化时必须加accountId"), console.error("初始化时必须加accountId"), console.error("初始化时必须加accountId"), console.error("初始化时必须加accountId"); }, 3e3 * i); } return _createClass(n, [{ key: "_init", value: function (e) { var t = this, i = e.accountId; this.name = e.name, this.appId = e.appId || e.appid; var n = e.serverUrl || e.server_url; this.serverUrl = n + "/sync_xcx", this.serverDebugUrl = n + "/data_debug", this.configUrl = n + "/config", this.autoTrackProperties = {}, PlatformAPI.initConfig(e), this._queue = [], this._setAutoTrackProperties({ "#session_id": _.UUIDv4() }), this.updateConfig(this.configUrl, this.appId), e.isChildInstance ? this._state = {} : (logger$1.enabled = e.enableLog, this.instances = [], this._state = { getSystemInfo: !1, initComplete: !1 }, PlatformAPI.setGlobal(this, this.name)), this.store = new ThinkingDataPersistence(e, function () { t.config.asyncPersistence && _.isFunction(t.config.persistenceComplete) && t.config.persistenceComplete(t), t._updateState(); }), this.login(i), this.enabled = !_.isBoolean(this.store._get("ta_enabled")) || this.store._get("ta_enabled"), this.isOptOut = !!_.isBoolean(this.store._get("ta_isOptOut")) && this.store._get("ta_isOptOut"), this.unsetSuperProperty("#session_id"), !e.isChildInstance && e.autoTrack && (this.autoTrack = PlatformAPI.initAutoTrackInstance(this, e)), void 0 !== this.config.enableBatch && !1 !== this.config.enableBatch && (this.batchConsumer = new BatchConsumer(this.config, this), this.batchConsumer.batchInterval()), this.startBeatHeart(); } }, { key: "startBeatHeart", value: function () { var e = this, t = 3e4; _.isUndefined(this.config.heartInterval) || _.isNumber(this.config.heartInterval) && (t = this.config.heartInterval), t <= 0 || (this.timeEvent("ta_heart"), setTimeout(function () { e.track("ta_heart"), e.startBeatHeart(); }, t)); } }, { key: "initSystemInfo", value: function () { var e = this; this.config.isChildInstance || systemInformation.getSystemInfo(function () { e._updateState({ getSystemInfo: !0 }); }); } }, { key: "updateConfig", value: function (t, i) { var n = this, e = _.createExtraHeaders(), a = this; e["content-type"] = "application/json"; var r = PlatformAPI.request({ url: t + "?appid=" + i, method: "GET", header: e, success: function (e) { _.isUndefined(e) || _.isUndefined(e.data) || (logger$1.info("Get remote config success(" + i + ") :" + JSON.stringify(e.data)), _.isUndefined(e.data.data) || (n.config.syncBatchSize = e.data.data.sync_batch_size, n.config.syncInterval = e.data.data.sync_interval, n.config.heartInterval = e.data.data.heart_interval, n.config.disableEventList = e.data.data.disable_event_list, n.config.canReport = e.data.data.canReport, 1 !== n.config.canReport && logger$1.warn("server stop"), _.isUndefined(e.data.data.secret_key) || (e = e.data.data.secret_key, n.config.secretKey = { publicKey: e.key, version: e.version }))); }, fail: function (e) { logger$1.info("Get remote config fail(" + i + ") :" + e.errMsg), setTimeout(function () { a.updateConfig(t, i); }, 1e4); } }); setTimeout(function () { (_.isObject(r) || _.isPromise(r)) && _.isFunction(r.abort) && r.abort(); }, 5e3); } }, { key: "initInstance", value: function (e, t) { if (!PlatformAPI.isWxPlat() || !this.isTADisable)
            if (this.config.isChildInstance)
                ...
                if (_.isString(e) && e !== this.name && _.isUndefined(this[e])) {
                    t = new n(_.extend({}, this.config, { enablePersistence: !1, isChildInstance: !0, name: e }, t));
                    return this[e] = t, this.instances.push(e), this[e]._state = this._state, t;
                }
                logger$1.warn("initInstance() failed due to the name is invalid: " + e);
            } } }, { key: "lightInstance", value: function (e) { if (!PlatformAPI.isWxPlat() || !this.isTADisable)
            return this[e]; } }, { key: "_setAutoTrackProperties", value: function (e) { _.extend(this.autoTrackProperties, e); } }, { key: "init", value: function () { if (!PlatformAPI.isWxPlat() || !this.isTADisable) {
            if (this.initSystemInfo(), this._state.initComplete)
                return !1;
            this._updateState({ initComplete: !0 }), logger$1.info("TDAnalytics SDK initialize success, AppId = " + this.config.appId + ", ServerUrl = " + this.config.serverUrl + ", Mode = " + this.config.model + ", DeviceId = " + this.getDeviceId() + ", Lib = " + Config.LIB_NAME + ", LibVersion = " + Config.LIB_VERSION);
        } } }, { key: "_isReady", value: function () { return this._state.getSystemInfo && this._state.initComplete && this.store.initComplete && this.getDeviceId() && this.store.getAccountId(); } }, { key: "_updateState", value: function (e) { var t = this; _.isObject(e) && _.extend(this._state, e), this._onStateChange(), _.each(this.instances, function (e) { t[e]._onStateChange(); }); } }, { key: "_onStateChange", value: function () { var t = this; this._isReady() && this._queue && 0 < this._queue.length && (_.each(this._queue, function (e) { t[e[0]].apply(t, slice.call(e[1])); }), this._queue = []); } }, { key: "_hasDisabled", value: function () { var e = !this.enabled || this.isOptOut || 1 !== this.config.canReport; return e && logger$1.info("SDK is Pause or Stop!"), e; } }, { key: "_sendRequest", value: function (e, t, i) { if (!this._hasDisabled())
            if (_.isUndefined(this.config.disableEventList) || !this.config.disableEventList.includes(e.eventName)) {
                t = _.isDate(t) ? t : new Date;
                var n = { data: [{ "#type": e.type, "#time": _.formatDate(_.formatTimeZone(t, this.config.zoneOffset)), "#distinct_id": this.store.getDistinctId() }] };
                this.store.getAccountId() && (n.data[0]["#account_id"] = this.store.getAccountId()), "track" === e.type || "track_update" === e.type || "track_overwrite" === e.type ? (n.data[0]["#event_name"] = e.eventName, "track_update" === e.type || "track_overwrite" === e.type ? n.data[0]["#event_id"] = e.extraId : e.firstCheckId && (n.data[0]["#first_check_id"] = e.firstCheckId), n.data[0].properties = _.extend({ "#zone_offset": _.getTimeZone(t, this.config.zoneOffset) }, systemInformation.properties, this.autoTrackProperties, this.store.getSuperProperties(), this.dynamicProperties ? this.dynamicProperties() : {}), t = this.store.removeEventTimer(e.eventName), _.isUndefined(t) || (a = (new Date).getTime() - t, 86400 < (a = parseFloat((a / 1e3).toFixed(3))) ? a = 86400 : a < 0 && (a = 0), n.data[0].properties["#duration"] = a)) : n.data[0].properties = {}, _.isObject(e.properties) && !_.isEmptyObject(e.properties) && _.extend(n.data[0].properties, e.properties), _.searchObjDate(n.data[0], this.config.zoneOffset), 1 < this.config.maxRetries && (n.data[0]["#uuid"] = _.UUIDv4()), n["#app_id"] = this.appId, logger$1.info("Tracking data, " + JSON.stringify(n, null, 4));
                var a = "debug" === this.config.debugMode || "debugOnly" === this.config.debugMode ? this.serverDebugUrl : this.serverUrl;
                if (_.isBoolean(this.config.enableEncrypt) && !0 === this.config.enableEncrypt && (n.data[0] = _.generateEncryptyData(n.data[0], this.config.secretKey)), this.batchConsumer && "none" === this.config.debugMode && !i)
                    return this.batchConsumer.add(n.data[0]), void (_.isFunction(e.onComplete) && e.onComplete({ code: 0, msg: "success" }));
                i ? (i = new FormData, "debug" === this.config.debugMode || "debugOnly" === this.config.debugMode ? (i.append("source", "client"), i.append("appid", this.appId), i.append("dryRun", "debugOnly" === this.config.debugMode ? 1 : 0), i.append("deviceId", this.getDeviceId()), i.append("data", JSON.stringify(n.data[0])), navigator.sendBeacon(a, i)) : (i = (new Date).getTime(), n["#flush_time"] = i, navigator.sendBeacon(a, JSON.stringify(n))), _.isFunction(e.onComplete) && e.onComplete({ statusCode: 200 })) : (senderQueue.runTimeout(this.config.sendTimeout) && senderQueue.resetTimeout(), senderQueue.enqueue(n, a, { maxRetries: this.config.maxRetries, sendTimeout: this.config.sendTimeout, callback: e.onComplete, debugMode: this.config.debugMode, deviceId: this.getDeviceId() }));
            }
            else
                logger$1.info("Disabled Event : " + e.eventName); } }, { key: "_isObjectParams", value: function (e) { return _.isObject(e) && _.isFunction(e.onComplete); } }, { key: "track", value: function (e, t, i, n) { var a; PlatformAPI.isWxPlat() && (this.wxSdk && (t = t || {}, this.wxSdk.track(e, t)), this.isTADisable) || this._hasDisabled() || (this._isObjectParams(e) && (e = (a = e).eventName, t = a.properties, i = a.time, n = a.onComplete), PropertyChecker.event(e) && PropertyChecker.properties(t) || !this.config.strict ? this._internalTrack(e, t, i, n, !1, !0) : _.isFunction(n) && n({ code: -1, msg: "invalid parameters" })); } }, { key: "trackUpdate", value: function (e) { var t, i; PlatformAPI.isWxPlat() && this.isTADisable || this._hasDisabled() || (e && e.eventId && (PropertyChecker.event(e.eventName) && PropertyChecker.properties(e.properties) || !this.config.strict) ? this._isReady() ? (t = _.checkCalibration(e.properties, e.time, this.config.enableCalibrationTime), i = _.isDate(e.time) ? e.time : new Date, this._sendRequest({ type: "track_update", eventName: e.eventName, properties: t, onComplete: e.onComplete, extraId: e.eventId }, i)) : this._queue.push(["trackUpdate", [e]]) : (logger$1.warn("Invalide parameter for trackUpdate: you should pass an object contains eventId to trackUpdate()"), _.isFunction(e.onComplete) && e.onComplete({ code: -1, msg: "invalid parameters" }))); } }, { key: "trackOverwrite", value: function (e) { var t, i; PlatformAPI.isWxPlat() && this.isTADisable || this._hasDisabled() || (e && e.eventId && (PropertyChecker.event(e.eventName) && PropertyChecker.properties(e.properties) || !this.config.strict) ? this._isReady() ? (t = _.checkCalibration(e.properties, e.time, this.config.enableCalibrationTime), i = _.isDate(e.time) ? e.time : new Date, this._sendRequest({ type: "track_overwrite", eventName: e.eventName, properties: t, onComplete: e.onComplete, extraId: e.eventId }, i)) : this._queue.push(["trackOverwrite", [e]]) : (logger$1.warn("Invalide parameter for trackOverwrite: you should pass an object contains eventId to trackOverwrite()"), _.isFunction(e.onComplete) && e.onComplete({ code: -1, msg: "invalid parameters" }))); } }, { key: "trackFirstEvent", value: function (e) { var t, i; PlatformAPI.isWxPlat() && this.isTADisable || this._hasDisabled() || (e && e.eventName && (PropertyChecker.event(e.eventName) && PropertyChecker.properties(e.properties) || !this.config.strict) ? this._isReady() ? (t = _.checkCalibration(e.properties, e.time, this.config.enableCalibrationTime), i = _.isDate(e.time) ? e.time : new Date, this._sendRequest({ type: "track", eventName: e.eventName, properties: t, onComplete: e.onComplete, firstCheckId: e.firstCheckId || this.getDeviceId() }, i)) : this._queue.push(["trackFirstEvent", [e]]) : (logger$1.warn("Invalide parameter for trackFirstEvent: you should pass an object contains eventName to trackFirstEvent()"), _.isFunction(e.onComplete) && e.onComplete({ code: -1, msg: "invalid parameters" }))); } }, { key: "_internalTrack", value: function (e, t, i, n, a, r) { !r && (this.wxSdk && ((t = t || {}).trackBy = "ThinkingData", this.wxSdk.track(e, t)), this.isTADisable) || this._hasDisabled() || (r = _.checkCalibration(t, i, this.config.enableCalibrationTime), i = _.isDate(i) ? i : new Date, this._isReady() ? this._sendRequest({ type: "track", eventName: e, properties: r, onComplete: n }, i, a) : this._queue.push(["_internalTrack", [e, t, i, n, a, !0]])); } }, { key: "userSet", value: function (e, t, i) { var n; PlatformAPI.isWxPlat() && this.isTADisable || this._hasDisabled() || (this._isObjectParams(e) && (e = (n = e).properties, t = n.time, i = n.onComplete), PropertyChecker.propertiesMust(e) || !this.config.strict ? (t = _.isDate(t) ? t : new Date, this._isReady() ? this._sendRequest({ type: "user_set", properties: e, onComplete: i }, t) : this._queue.push(["userSet", [e, t, i]])) : (logger$1.warn("calling userSet failed due to invalid arguments"), _.isFunction(i) && i({ code: -1, msg: "invalid parameters" }))); } }, { key: "userSetOnce", value: function (e, t, i) { var n; PlatformAPI.isWxPlat() && this.isTADisable || this._hasDisabled() || (this._isObjectParams(e) && (e = (n = e).properties, t = n.time, i = n.onComplete), PropertyChecker.propertiesMust(e) || !this.config.strict ? (t = _.isDate(t) ? t : new Date, this._isReady() ? this._sendRequest({ type: "user_setOnce", properties: e, onComplete: i }, t) : this._queue.push(["userSetOnce", [e, t, i]])) : (logger$1.warn("calling userSetOnce failed due to invalid arguments"), _.isFunction(i) && i({ code: -1, msg: "invalid parameters" }))); } }, { key: "userUnset", value: function (e, t, i) { var n; PlatformAPI.isWxPlat() && this.isTADisable || this._hasDisabled() || (this._isObjectParams(n) && (e = n.property, t = n.time, i = n.onComplete), PropertyChecker.propertyName(e) || !this.config.strict ? (t = _.isDate(t) ? t : new Date, this._isReady() ? ((n = {})[e] = 0, this._sendRequest({ type: "user_unset", properties: n, onComplete: i }, t)) : this._queue.push(["userUnset", [e, i, t]])) : (logger$1.warn("calling userUnset failed due to invalid arguments"), _.isFunction(i) && i({ code: -1, msg: "invalid parameters" }))); } }, { key: "userDel", value: function (e, t) { var i; PlatformAPI.isWxPlat() && this.isTADisable || this._hasDisabled() || (this._isObjectParams(e) && (e = (i = e).time, t = i.onComplete), e = _.isDate(e) ? e : new Date, this._isReady() ? this._sendRequest({ type: "user_del", onComplete: t }, e) : this._queue.push(["userDel", [e, t]])); } }, { key: "userAdd", value: function (e, t, i) { var n; PlatformAPI.isWxPlat() && this.isTADisable || this._hasDisabled() || (this._isObjectParams(e) && (e = (n = e).properties, t = n.time, i = n.onComplete), PropertyChecker.userAddProperties(e) || !this.config.strict ? (t = _.isDate(t) ? t : new Date, this._isReady() ? this._sendRequest({ type: "user_add", properties: e, onComplete: i }, t) : this._queue.push(["userAdd", [e, t, i]])) : (logger$1.warn("calling userAdd failed due to invalid arguments"), _.isFunction(i) && i({ code: -1, msg: "invalid parameters" }))); } }, { key: "userAppend", value: function (e, t, i) { var n; PlatformAPI.isWxPlat() && this.isTADisable || this._hasDisabled() || (this._isObjectParams(e) && (e = (n = e).properties, t = n.time, i = n.onComplete), PropertyChecker.userAppendProperties(e) || !this.config.strict ? (t = _.isDate(t) ? t : new Date, this._isReady() ? this._sendRequest({ type: "user_append", properties: e, onComplete: i }, t) : this._queue.push(["userAppend", [e, t, i]])) : (logger$1.warn("calling userAppend failed due to invalid arguments"), _.isFunction(i) && i({ code: -1, msg: "invalid parameters" }))); } }, { key: "userUniqAppend", value: function (e, t, i) { var n; PlatformAPI.isWxPlat() && this.isTADisable || this._hasDisabled() || (this._isObjectParams(e) && (e = (n = e).properties, t = n.time, i = n.onComplete), PropertyChecker.userAppendProperties(e) || !this.config.strict ? (t = _.isDate(t) ? t : new Date, this._isReady() ? this._sendRequest({ type: "user_uniq_append", properties: e, onComplete: i }, t) : this._queue.push(["userUniqAppend", [e, t, i]])) : (logger$1.warn("calling userAppend failed due to invalid arguments"), _.isFunction(i) && i({ code: -1, msg: "invalid parameters" }))); } }, { key: "flush", value: function () { PlatformAPI.isWxPlat() && this.isTADisable || this.batchConsumer && "none" === this.config.debugMode && this.batchConsumer.flush(); } }, { key: "authorizeOpenID", value: function (e) { this.identify(e); } }, { key: "identify", value: function (e) { if (!(PlatformAPI.isWxPlat() && this.isTADisable || this._hasDisabled())) {
            if ("number" == typeof e)
                e = String(e);
            else if ("string" != typeof e)
                return !1;
            this.store.setDistinctId(e), logger$1.info("Setting distinct ID, DistinctId = " + e);
        } } }, { key: "getDistinctId", value: function () { return PlatformAPI.isWxPlat() && this.isTADisable ? "" : this.store.getDistinctId(); } }, { key: "login", value: function (e) { if (!(PlatformAPI.isWxPlat() && this.isTADisable || this._hasDisabled())) {
            if ("number" == typeof e)
                e = String(e);
            else if ("string" != typeof e)
                return !1;
            this.store.setAccountId(e), logger$1.info("Login SDK, AccountId = " + e);
        } } }, { key: "getAccountId", value: function () { return PlatformAPI.isWxPlat() && this.isTADisable ? "" : this.store.getAccountId(); } }, { key: "logout", value: function () { PlatformAPI.isWxPlat() && this.isTADisable || this._hasDisabled() || (this.store.setAccountId(null), logger$1.info("Logout SDK")); } }, { key: "setSuperProperties", value: function (e) { PlatformAPI.isWxPlat() && this.isTADisable || this._hasDisabled() || (PropertyChecker.propertiesMust(e) || !this.config.strict ? this.store.setSuperProperties(e) : logger$1.warn("setSuperProperties parameter must be a valid property value")); } }, { key: "clearSuperProperties", value: function () { PlatformAPI.isWxPlat() && this.isTADisable || this._hasDisabled() || this.store.setSuperProperties({}, !0); } }, { key: "unsetSuperProperty", value: function (e) { var t; PlatformAPI.isWxPlat() && this.isTADisable || this._hasDisabled() || _.isString(e) && (delete (t = this.getSuperProperties())[e], this.store.setSuperProperties(t, !0)); } }, { key: "getSuperProperties", value: function () { return PlatformAPI.isWxPlat() && this.isTADisable ? {} : this.store.getSuperProperties(); } }, { key: "getPresetProperties", value: function () { if (PlatformAPI.isWxPlat() && this.isTADisable)
            return {}; var e = systemInformation.properties, t = {}, i = e["#os"]; t.os = _.isUndefined(i) ? "" : i; i = e["#screen_width"]; t.screenWidth = _.isUndefined(i) ? 0 : i; i = e["#screen_height"]; t.screenHeight = _.isUndefined(i) ? 0 : i; i = e["#network_type"]; t.networkType = _.isUndefined(i) ? "" : i; i = e["#device_model"]; t.deviceModel = _.isUndefined(i) ? "" : i; i = e["#os_version"]; t.osVersion = _.isUndefined(i) ? "" : i, t.deviceId = this.getDeviceId(); var n = _.getTimeZone(new Date, this.config.zoneOffset); t.zoneOffset = n; e = e["#manufacturer"]; return t.manufacturer = _.isUndefined(e) ? "" : e, t.toEventPresetProperties = function () { return { "#device_model": t.deviceModel, "#device_id": t.deviceId, "#screen_width": t.screenWidth, "#screen_height": t.screenHeight, "#os": t.os, "#os_version": t.osVersion, "#network_type": t.networkType, "#zone_offset": n, "#manufacturer": t.manufacturer }; }, t; } }, { key: "setDynamicSuperProperties", value: function (e) { if (PlatformAPI.isWxPlat() && this.isTADisable)
            return {}; this._hasDisabled() || ("function" == typeof e ? PropertyChecker.properties(e()) || !this.config.strict ? this.dynamicProperties = e : logger$1.warn("A dynamic public property must return a valid property value") : logger$1.warn("setDynamicSuperProperties parameter must be a function type")); } }, { key: "timeEvent", value: function (e, t) { if (PlatformAPI.isWxPlat() && this.isTADisable)
            return {}; this._hasDisabled() || (t = _.isDate(t) ? t : new Date, this._isReady() ? PropertyChecker.event(e) || !this.config.strict ? this.store.setEventTimer(e, t.getTime()) : logger$1.warn("calling timeEvent failed due to invalid eventName: " + e) : this._queue.push(["timeEvent", [e, t]])); } }, { key: "getDeviceId", value: function () { return PlatformAPI.isWxPlat() && this.isTADisable ? "" : systemInformation.properties["#device_id"]; } }, { key: "enableTracking", value: function (e) { PlatformAPI.isWxPlat() && this.isTADisable || (this.enabled = e, this.store._set("ta_enabled", e)); } }, { key: "optOutTracking", value: function () { PlatformAPI.isWxPlat() && this.isTADisable || (this.store.setSuperProperties({}, !0), this.store.setDistinctId(_.UUID()), this.store.setAccountId(null), this._queue.splice(0, this._queue.length), this.isOptOut = !0, this.store._set("ta_isOptOut", !0)); } }, { key: "optOutTrackingAndDeleteUser", value: function () { var e; PlatformAPI.isWxPlat() && this.isTADisable || (e = new Date, this._sendRequest({ type: "user_del" }, e), this.optOutTracking()); } }, { key: "optInTracking", value: function () { PlatformAPI.isWxPlat() && this.isTADisable || (this.isOptOut = !1, this.store._set("ta_isOptOut", !1)); } }, { key: "setTrackStatus", value: function (e) { if (!PlatformAPI.isWxPlat() || !this.isTADisable) {
            switch (e) {
                case "PAUSE":
            ...
            var e = window, t = this;
            return e.__autoTrackCallback = function (e) { if (_.isFunction(t.config.autoTrack.callback)) {
                e = t.config.autoTrack.callback(e);
                return JSON.stringify(e);
            } return "{}"; }, void this.startThinkingAnalyticsForNative(this.appId);
