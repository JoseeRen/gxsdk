...
let Gx_shareFriend = (() => {
    ...
    var Gx_shareFriend = _classThis = class extends _classSuper {
        ...
        start() {
            ...
            let bound = {};
            bound.width = this.sprite.node.getComponent(cc_1.UITransform).width;
            bound.height = this.sprite.node.getComponent(cc_1.UITransform).height;
            let phoneInfo = window["wx"].getSystemInfoSync();
        ...
        constructor() {
            super(...arguments);
            this.texture = new cc_1.Texture2D();
    ...
    (() => {
        ...
        _sprite_decorators = [property(cc_1.Sprite)];
