...
let NewClass = (() => {
    ...
    var NewClass = _classThis = class extends _classSuper {
        ...
        onLoad() {
            var last = cc_1.sys.localStorage.getItem("TTRewardTime");
            ...
            let width = cc_1.view.getVisibleSize().width;
            let height = cc_1.view.getVisibleSize().height;
            if (width > height) {
                //横屏
            ...
            this.stringlabel = this.curRootNode.getChildByName("rewardlabel").getComponent(cc_1.Label);
        ...
        start() {
            ...
            if (this.havettreward) {
                ...
                this.getReward.getComponent(cc_1.Button).interactable = false;
        ...
        onclickgetReward() {
            ...
            cc_1.sys.localStorage.setItem("TTRewardTime", nowtime);
            this.getReward.getComponent(cc_1.Button).interactable = false;
            this.haverewardtip.active = true;
        }
        close() {
        ...
        init(rewardCallback, rewardNum, iconAndName) {
            ...
            let component = this.curRootNode.getChildByName("icon").getComponent(cc_1.Sprite);
            if (component) {
    ...
    (() => {
        ...
        _getReward_decorators = [property(cc_1.Node)];
        _gotoBtn_decorators = [property(cc_1.Node)];
        _stringlabel_decorators = [property(cc_1.Label)];
        _haverewardtip_decorators = [property(cc_1.Node)];
