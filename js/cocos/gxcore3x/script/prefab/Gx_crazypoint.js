...
let Gx_crazypoint = (() => {
    ...
    var Gx_crazypoint = _classThis = class extends _classSuper {
        ...
        onLoad() {
            ...
            if (winSize.width > winSize.height) {
                this.btnNode.setPosition((0, cc_1.v3)(400, 0));
                this.boxNode.setPosition((0, cc_1.v3)(-310.119, -52));
                this.title.setPosition((0, cc_1.v3)(0, 245));
                this.title2.setPosition((0, cc_1.v3)(570, -90));
            }
        ...
        onDestroy() {
            cc_1.director.off("dest", this.onDest, this);
            cc_1.game.off(cc_1.Game.EVENT_HIDE, this.gameHide, this);
            cc_1.game.off(cc_1.Game.EVENT_SHOW, this.gameShow, this);
        ...
        touchHandler(e, t) {
            ...
            if (this.get_time() - this.showVideoTime < 500) {
                ...
                if (this.num == 4 && !this.videoShowed) {
                    ...
                    if (!this.listening) {
                        this.listening = true;
                        cc_1.director.on("dest", this.onDest, this);
                        cc_1.game.on(cc_1.Game.EVENT_HIDE, this.gameHide, this);
                        cc_1.game.on(cc_1.Game.EVENT_SHOW, this.gameShow, this);
                    }
                    if (this.isBanner) {
    ...
    (() => {
        ...
        _progressNode_decorators = [property(cc_1.ProgressBar)];
        _img_xiangPiCa_decorators = [property(cc_1.Node)];
        _btnNode_decorators = [property(cc_1.Node)];
        _boxNode_decorators = [property(cc_1.Node)];
        _title_decorators = [property(cc_1.Node)];
        _title2_decorators = [property(cc_1.Node)];
