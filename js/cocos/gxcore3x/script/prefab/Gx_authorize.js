...
let Gx_authorize = (() => {
    ...
    (() => {
        ...
        _userNode_decorators = [property(cc_1.Node)];
        _andTextNode_decorators = [property(cc_1.Node)];
        _privacyNode_decorators = [property(cc_1.Node)];
        _erCiNode_decorators = [property(cc_1.Node)];
        _refuseBtn_decorators = [property(cc_1.Node)];
        _agreeBtn_decorators = [property(cc_1.Node)];
        _closeBtn_decorators = [property(cc_1.Node)];
        _tipsLabel_decorators = [property(cc_1.Label)];
