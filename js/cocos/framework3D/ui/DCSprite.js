...
let DCSprite = (() => {
    let _classDecorators = [ccclass, menu("DCUI/DCSprite"), requireComponent(cc_1.SpriteComponent)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = DCUI_1.default;
    var DCSprite = _classThis = class extends _classSuper {
        onLoad() {
            this.sprite = this.getComponent(cc_1.SpriteComponent);
        }
        refreshSpriteFrame(v) {
            // this.sprite.spriteFrame = v;
            let spriteframe = SpriteFrameCache_1.default.instance.getSpriteFrame(v).then(sf => {
    ...
    __setFunctionName(_classThis, "DCSprite");
    (() => {
        var _a;
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        DCSprite = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return DCSprite = _classThis;
})();
