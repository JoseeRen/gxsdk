...
let ScaleAnim = (() => {
    let _classDecorators = [ccclass("ScaleAnim"), menu("qanim/ScaleAnim")];
    ...
    var ScaleAnim = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
            this.from = __runInitializers(this, _from_initializers, cc_1.Vec3.ZERO);
            this.to = (__runInitializers(this, _from_extraInitializers), __runInitializers(this, _to_initializers, cc_1.Vec3.ZERO));
            this.tmp_scale = (__runInitializers(this, _to_extraInitializers), (0, cc_1.v3)());
        }
        onTick(t) {
            this.node.scale = cc_1.Vec3.lerp(this.tmp_scale, this.from, this.to, t);
        }
        start() {
            this.pasr.reset();
        }
    ...
    __setFunctionName(_classThis, "ScaleAnim");
    (() => {
        var _a;
        ...
        ScaleAnim = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ScaleAnim = _classThis;
})();
