...
let wxSysInfo;
let WxgetInfoButton = (() => {
    let _classDecorators = [ccclass, menu("Wxsdk/WxgetInfoButton")];
    ...
    var WxgetInfoButton = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
        ...
        start() {
            Platform_1.default.checkAuth().then(v => {
                if (!v) {
                    if (CC_WECHAT) {
                    ...
                    this.node.on(cc_1.Node.EventType.TOUCH_END, this.onClick.bind(this, v, false));
                    // this.handler.emit([v])
                    //n已授权无需创建 按钮
    ...
    __setFunctionName(_classThis, "WxgetInfoButton");
    (() => {
        var _a;
        ...
        WxgetInfoButton = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return WxgetInfoButton = _classThis;
})();
