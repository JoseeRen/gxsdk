...
/*  _BASE_URL: "https://api.sjzgxwl.com",
  ...
  init(config, callback) {
      ...
      if (window["TDAnalytics"]) {
          ...
          TDAnalytics.login(config.openId);
  ...
  eventLevelStart(lvName, properties) {
      if (window["TDAnalytics"]) {
          ...
          TDAnalytics.track("gxbi_level_start", assign);
      }
  },
  ...
  eventLevelFail(lvName, properties) {
      if (window["TDAnalytics"]) {
          ...
          TDAnalytics.track("gxbi_level_fail", assign);
      }
  },
  ...
  eventLevelSuccess(lvName, properties) {
      if (window["TDAnalytics"]) {
          ...
          TDAnalytics.track("gxbi_level_success", assign);
      }
  },
