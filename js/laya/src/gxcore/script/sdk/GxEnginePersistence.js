...
class GxEnginePersistence {
    ...
    _init(options, callback) {
        ...
        let todayFirstSceneDate = null;
        let todayFirstScene = null;
        if (storageData) {
            todayFirstSceneDate = storageData["current_first_scene_date"];
            todayFirstScene = storageData["current_first_scene"];
        }
        const currentDate = new Date().toLocaleDateString();
        if (todayFirstScene && todayFirstSceneDate && todayFirstSceneDate === currentDate) {
            systemInformation.properties.$today_first_scene = String(storageData.current_first_scene);
        }
        else {
