...
class CwControl extends Laya.Script3D {
    constructor() {
        super();
    }
    onEnable() {
    ...
    jiHuoFun(leiXing) {
        ...
        if (leiXing == 0) {
            ...
            this.wt = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("shouQiang_Bing"), this.owner.getChildByName("wuTi"));
            this.wt.transform.localPosition = new Laya.Vector3(0, 0, 0);
            this.wt.getChildAt(1).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.wt.getChildAt(2).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            ...
            this.dengJi = PlayerData_1.default.GetUserData("shangDianDengJiZu")[0]; //等级
            //作战先锋 首个手枪兵为 队长  属性全面提升
            if (GameManager_1.default.curLevelManager.moShi == "zuoZhanXianFeng") {
                if (GameManager_1.default.curPlayerControl.fanHuiRenShu() == 0) {
                    GameManager_1.default.curPlayerControl.duiZhangObj = this.owner;
                }
            }
        }
        else if (leiXing == 2) {
            this.wt = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("chongFeng_Bing"), this.owner.getChildByName("wuTi"));
            this.wt.transform.localPosition = new Laya.Vector3(0, 0, 0);
            this.wt.getChildAt(1).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.wt.getChildAt(2).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            ...
            this.dengJi = PlayerData_1.default.GetUserData("shangDianDengJiZu")[1]; //等级
        }
        else if (leiXing == 3) { //步枪
            this.wt = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("buQiang_Bing"), this.owner.getChildByName("wuTi"));
            this.wt.transform.localPosition = new Laya.Vector3(0, 0, 0);
            this.wt.getChildAt(1).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.wt.getChildAt(2).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            ...
            this.dangQianXueLiang = this.xueLiang; //当前血量
            this.kaiHuoYinXiao = "buQiang"; //开火音效
            this.dengJi = PlayerData_1.default.GetUserData("shangDianDengJiZu")[2]; //等级
        }
        else if (leiXing == 4) { //机关枪
            this.wt = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("jiQiang_Bing"), this.owner.getChildByName("wuTi"));
            this.wt.transform.localPosition = new Laya.Vector3(0, 0, 0);
            this.wt.getChildAt(1).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.wt.getChildAt(2).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.gongJiFanWei = parseInt(GameManager_1.default.jsonShuJv["jiQiangShouShuJv"]["gongJiFenWei"]); //攻击范围
            this.sheSu2 = parseInt(GameManager_1.default.jsonShuJv["jiQiangShouShuJv"]["sheSu"]); //射速
            ...
            this.danQianZiDan = this.ziDanRongLiang; //当前子弹
            this.gongJiLi = parseInt(GameManager_1.default.jsonShuJv["jiQiangShouShuJv"]["gongJiLi"]); //攻击力
            this.xueLiang = parseInt(GameManager_1.default.jsonShuJv["jiQiangShouShuJv"]["xueLiang"]); //血量
            this.dangQianXueLiang = this.xueLiang; //当前血量
            this.kaiHuoYinXiao = "jiQiang"; //开火音效
            this.dengJi = PlayerData_1.default.GetUserData("shangDianDengJiZu")[4]; //等级
        }
        else if (leiXing == 5) { //喷火枪
            this.wt = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("huoQiang_Bing"), this.owner.getChildByName("wuTi"));
            this.wt.transform.localPosition = new Laya.Vector3(0, 0, 0);
            this.wt.getChildByName("FX_shanxinghuoyan").active = false;
            this.wt.getChildAt(1).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.wt.getChildAt(2).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.gongJiFanWei = parseInt(GameManager_1.default.jsonShuJv["penHuoBingShuJv"]["gongJiFenWei"]); //攻击范围
            this.sheSu2 = parseInt(GameManager_1.default.jsonShuJv["penHuoBingShuJv"]["sheSu"]); //射速
            this.huaNDanShiJian = parseInt(GameManager_1.default.jsonShuJv["penHuoBingShuJv"]["huaNDanShiJian"]); //换弹时间
            this.shengYuHuanDanShiJian = this.huaNDanShiJian; //剩余换弹时间
            this.ziDanRongLiang = parseInt(GameManager_1.default.jsonShuJv["penHuoBingShuJv"]["ziDanRongLiang"]); //弹夹容量
            this.danQianZiDan = this.ziDanRongLiang; //当前子弹
            this.gongJiLi = parseInt(GameManager_1.default.jsonShuJv["penHuoBingShuJv"]["gongJiLi"]); //攻击力
            this.xueLiang = parseInt(GameManager_1.default.jsonShuJv["penHuoBingShuJv"]["xueLiang"]); //血量
            this.dangQianXueLiang = this.xueLiang; //当前血量
            this.kaiHuoYinXiao = "penHuo"; //开火音效
            this.dengJi = PlayerData_1.default.GetUserData("shangDianDengJiZu")[5]; //等级
        }
        else if (leiXing == 6) { //狙击枪
            this.wt = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("jvJi_Bing"), this.owner.getChildByName("wuTi"));
            this.wt.transform.localPosition = new Laya.Vector3(0, 0, 0);
            this.wt.getChildAt(1).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.wt.getChildAt(2).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.gongJiFanWei = parseInt(GameManager_1.default.jsonShuJv["jvJiShouShuJv"]["gongJiFenWei"]); //攻击范围
            this.sheSu2 = parseInt(GameManager_1.default.jsonShuJv["jvJiShouShuJv"]["sheSu"]); //射速
            this.huaNDanShiJian = parseInt(GameManager_1.default.jsonShuJv["jvJiShouShuJv"]["huaNDanShiJian"]); //换弹时间
            this.shengYuHuanDanShiJian = this.huaNDanShiJian; //剩余换弹时间
            this.ziDanRongLiang = parseInt(GameManager_1.default.jsonShuJv["jvJiShouShuJv"]["ziDanRongLiang"]); //弹夹容量
            this.danQianZiDan = this.ziDanRongLiang; //当前子弹
            this.gongJiLi = parseInt(GameManager_1.default.jsonShuJv["jvJiShouShuJv"]["gongJiLi"]); //攻击力
            this.xueLiang = parseInt(GameManager_1.default.jsonShuJv["jvJiShouShuJv"]["xueLiang"]); //血量
            this.dangQianXueLiang = this.xueLiang; //当前血量
            this.kaiHuoYinXiao = "jvJi"; //开火音效
            this.dengJi = PlayerData_1.default.GetUserData("shangDianDengJiZu")[3]; //等级
        }
        else if (leiXing == 7) { //榴弹兵
            this.wt = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("liuDan_Bing"), this.owner.getChildByName("wuTi"));
            this.wt.transform.localPosition = new Laya.Vector3(0, 0, 0);
            this.wt.getChildAt(1).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.wt.getChildAt(2).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.gongJiFanWei = parseInt(GameManager_1.default.jsonShuJv["liuDanShouShuJv"]["gongJiFenWei"]); //攻击范围
            this.sheSu2 = parseInt(GameManager_1.default.jsonShuJv["liuDanShouShuJv"]["sheSu"]); //射速
            this.huaNDanShiJian = parseInt(GameManager_1.default.jsonShuJv["liuDanShouShuJv"]["huaNDanShiJian"]); //换弹时间
            this.shengYuHuanDanShiJian = this.huaNDanShiJian; //剩余换弹时间
            this.ziDanRongLiang = parseInt(GameManager_1.default.jsonShuJv["liuDanShouShuJv"]["ziDanRongLiang"]); //弹夹容量
            this.danQianZiDan = this.ziDanRongLiang; //当前子弹
            this.gongJiLi = parseInt(GameManager_1.default.jsonShuJv["liuDanShouShuJv"]["gongJiLi"]); //攻击力
            this.xueLiang = parseInt(GameManager_1.default.jsonShuJv["liuDanShouShuJv"]["xueLiang"]); //血量
            this.dangQianXueLiang = this.xueLiang; //当前血量
            this.kaiHuoYinXiao = "liuDan"; //开火音效
            this.dengJi = PlayerData_1.default.GetUserData("shangDianDengJiZu")[6]; //等级
        }
        else if (leiXing == 8) { //医疗兵
            this.wt = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("yiLiao_Bing"), this.owner.getChildByName("wuTi"));
            this.wt.transform.localPosition = new Laya.Vector3(0, 0, 0);
            this.wt.getChildAt(1).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.wt.getChildAt(2).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.gongJiFanWei = parseInt(GameManager_1.default.jsonShuJv["shouQiangBingShuJv"]["gongJiFenWei"]); //攻击范围
            ...
            this.wt = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("shenJingTuJiDui"), this.owner.getChildByName("wuTi"));
            this.wt.transform.localPosition = new Laya.Vector3(0, 0, 0);
            this.wt.getChildAt(1).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.wt.getChildAt(2).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.gongJiFanWei = parseInt(GameManager_1.default.jsonShuJv["tuJiDuiYuanShuJv"]["gongJiFenWei"]); //攻击范围
            ...
            this.wt = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("tongXunBing"), this.owner.getChildByName("wuTi"));
            this.wt.transform.localPosition = new Laya.Vector3(0, 0, 0);
            this.wt.getChildAt(1).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.wt.getChildAt(2).skinnedMeshRenderer.material = GameManager_1.default.models.getChildByName("piFuLan").meshRenderer.material;
            this.gongJiFanWei = parseInt(GameManager_1.default.jsonShuJv["tuJiDuiYuanShuJv"]["gongJiFenWei"]); //攻击范围
            ...
            this.wt = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("jiQiang_paoTai"), this.owner.getChildByName("wuTi"));
            this.wt.transform.localPosition = new Laya.Vector3(0, 0, 0);
            this.wt.getChildAt(0).meshRenderer.material = GameManager_1.default.models.getChildByName("paoTaiCaiZhiL").meshRenderer.material;
            this.wt.getChildAt(0).getChildAt(0).meshRenderer.material = GameManager_1.default.models.getChildByName("paoTaiCaiZhiL").meshRenderer.material;
            this.wt.getChildAt(0).getChildAt(0).getChildAt(0).meshRenderer.material = GameManager_1.default.models.getChildByName("paoTaiCaiZhiL").meshRenderer.material;
            this.gongJiFanWei = parseInt(GameManager_1.default.jsonShuJv["jiQiangShouShuJv"]["gongJiFenWei"]); //攻击范围
            this.sheSu2 = parseInt(GameManager_1.default.jsonShuJv["jiQiangShouShuJv"]["sheSu"]); //射速
            this.huaNDanShiJian = parseInt(GameManager_1.default.jsonShuJv["jiQiangShouShuJv"]["huaNDanShiJian"]); //换弹时间
            this.shengYuHuanDanShiJian = this.huaNDanShiJian; //剩余换弹时间
            ...
            this.danQianZiDan = this.ziDanRongLiang; //当前子弹
            this.gongJiLi = parseInt(GameManager_1.default.jsonShuJv["jiQiangShouShuJv"]["gongJiLi"]); //攻击力
            this.xueLiang = parseInt(GameManager_1.default.jsonShuJv["jiQiangShouShuJv"]["xueLiang"]) * 2; //血量
            this.dangQianXueLiang = this.xueLiang; //当前血量
            this.kaiHuoYinXiao = "jiQiang"; //开火音效
            ...
            this.wt = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("liuDan_paoTai"), this.owner.getChildByName("wuTi"));
            this.wt.transform.localPosition = new Laya.Vector3(0, 0, 0);
            this.wt.getChildAt(0).meshRenderer.material = GameManager_1.default.models.getChildByName("paoTaiCaiZhiL").meshRenderer.material;
            this.wt.getChildAt(0).getChildAt(0).meshRenderer.material = GameManager_1.default.models.getChildByName("paoTaiCaiZhiL").meshRenderer.material;
            this.wt.getChildAt(0).getChildAt(0).getChildAt(0).meshRenderer.material = GameManager_1.default.models.getChildByName("paoTaiCaiZhiL").meshRenderer.material;
            ...
            this.danQianZiDan = this.ziDanRongLiang; //当前子弹
            this.gongJiLi = parseInt(GameManager_1.default.jsonShuJv["liuDanShouShuJv"]["gongJiLi"]); //攻击力
            this.xueLiang = parseInt(GameManager_1.default.jsonShuJv["liuDanShouShuJv"]["xueLiang"]) * 2; //血量
            this.dangQianXueLiang = this.xueLiang; //当前血量
            this.kaiHuoYinXiao = "liuDan"; //开火音效
            // this.dengJi = PlayerData.GetUserData("shangDianDengJiZu")[4];  //等级
            this.dengJi = 1; //等级
        ...
        // 队长  属性全面提升
        if (GameManager_1.default.curLevelManager.moShi == "zuoZhanXianFeng") {
            if (GameManager_1.default.curPlayerControl.duiZhangObj == this.owner) {
        ...
        //根据等级 重置 血量 攻击力 和弹夹
        this.xueLiang = this.xueLiang + parseInt(GameManager_1.default.jsonShuJv["shangDianShuJv"]["shengJiXueLiang"]) * parseInt(this.dengJi);
        this.dangQianXueLiang = this.xueLiang;
        //火枪单独判断增加的攻击力
        if (leiXing == 5) {
            this.gongJiLi = this.gongJiLi + parseInt(GameManager_1.default.jsonShuJv["shangDianShuJv"]["shengJiGongJiLiHuoQiang"]) * parseInt(this.dengJi);
        }
        else {
            this.gongJiLi = this.gongJiLi + parseInt(GameManager_1.default.jsonShuJv["shangDianShuJv"]["shengJiGongJiLi"]) * parseInt(this.dengJi);
        }
        this.ziDanRongLiang = this.ziDanRongLiang + parseInt(GameManager_1.default.jsonShuJv["shangDianShuJv"]["shengJiDanJia"]) * parseInt(this.dengJi);
        this.danQianZiDan = this.ziDanRongLiang;
        //特殊加固 增加额外的血量
        if (GameManager_1.default.curLevelManager.zzxfDuiYingDeDengJi[8] > 0) {
        ...
        //往组合碰撞器形状中添加该碰撞器形状
        GameManager_1.default.curPlayerControl.pengZhuangJihe.addChildShape(boxShape);
        this.pengZhaungObj = boxShape; //绑定对应的碰撞
        //添加碰撞体
        GameManager_1.default.curPlayerControl.owner.getComponent(Laya.Rigidbody3D).colliderShape = GameManager_1.default.curPlayerControl.pengZhuangJihe;
    }
    daiJiFang() {
        if (this.state == "daiJi") {
            return;
    ...
    gouDaiFun() {
        ...
        //查看人数  小于等于1的话就失败
        var shu = GameManager_1.default.curPlayerControl.fanHuiRenShu();
        if (shu <= 0) {
            GameManager_1.default.curPlayerControl.shiBaiChuLiFun();
        }
        // 队长 
        if (GameManager_1.default.curLevelManager.moShi == "zuoZhanXianFeng") {
            if (GameManager_1.default.curPlayerControl.duiZhangObj == this.owner) {
                GameManager_1.default.curPlayerControl.duiZhangObj = null;
                UIManager_1.default.ShowGameTipUI("队长被击败了,无法获取 队长武器升级增益");
            }
        }
    }
    gouDaiTouFun() {
        ...
        if (this.pengZhaungObj != null) {
            GameManager_1.default.curPlayerControl.pengZhuangJihe.removeChildShape(this.pengZhaungObj); //移除对应的碰撞
        }
    }
    //受击
    shouJi(shuZhi) {
        //无视受击判断
        if (this.wt == null || this.state == "gouDai" || this.state == "gouDaiTou" || GameManager_1.default.curPlayerControl.state == "shiBai" || GameManager_1.default.curPlayerControl.state == "shengLi" || this.huDunObj != null) {
            return;
        }
        //受击高亮 炮台判断
        if (this.leiXing > 15) {
        ...
        if (PlayerData_1.default.GetUserData("xiangTongShiBingHeChengYd") == false || GameManager_1.default.curPlayerControl.state == "jiuYuan") {
            shuZhi = 0;
        }
        //无星时受到的伤害为三分之一
        if (GameManager_1.default.curLevelManager.nanDuDengJi == 0) {
            shuZhi = shuZhi / 3;
        }
        ...
        if (this.state == "daiJi") {
            ...
            */
            ...
            for (var i = 0; i < this.diRenJiHe.numChildren; i++) {
                ...
                for (var p = 0; p < this.diRenJiHe.getChildAt(i).numChildren; p++) {
                    ...
                    if (wt.numChildren == 0) { //木板上没东西就跳过
                        ...
                        if (wt.parent.getComponent(jiao_1.default).state == "gouDai" || wt.parent.getComponent(jiao_1.default).state == "gouDaiTou") {
                            continue;
                        }
                    }
            ...
            if (this.gongJimuBiao.name == "barrel01_A") {
                if (this.gongJimuBiao.getComponent(youTong_1.default) == null) {
                    this.daiJiFang();
                    return;
                }
            }
            else {
                if (this.gongJimuBiao == null || this.gongJimuBiao.getComponent(jiao_1.default).state == "gouDai" || this.gongJimuBiao.getComponent(jiao_1.default).state == "gouDaiTou") {
                    this.daiJiFang();
                    return;
                }
            }
            ...
            if (this.gongJimuBiao == null || jvLi > this.gongJiFanWei) {
                ...
                if (this.danQianZiDan <= 0) {
                    ...
                    //射速 神经突击队加成
                    var zhenShiSHeSu = this.sheSu2 * (1 - GameManager_1.default.curLevelManager.zzxfDuiYingDeDengJi[2] * parseInt(GameManager_1.default.jsonShuJv["zuoZhanXianFengMoShiShuJv"]["shenJingTuJiDuiGongSuZeng"]) / 100);
                    if (this.sheSu1 >= zhenShiSHeSu) {
                        ...
                        if (this.leiXing == 5) {
                            ...
                            //创建一颗子弹
                            if (this.leiXing == 6) {
                                var ziDanObj = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("ziDan2"), GameManager_1.default.curScene);
                            }
                            else if (this.leiXing == 7 || this.leiXing == 17) {
                                var ziDanObj = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("ziDan3"), GameManager_1.default.curScene);
                            }
                            else {
                                var ziDanObj = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("ziDan1"), GameManager_1.default.curScene);
                            }
            ...
            //相机跟随玩家
            GameManager_1.default.cameraTrans.position = this.moveTrans.position.clone();
            GameManager_1.default.cameraTrans.rotation = this.pathTrans.rotation.clone();
    ...
    zhiLiao(shuLiang) {
        ...
        //恢复特效
        var Tx = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("FX_huixue"), this.owner);
    ...
    huDun() {
        ...
        GameManager_1.default.PlaySound("huDun");
        //护盾特效
        var Tx = Laya.Sprite3D.instantiate(GameManager_1.default.models.getChildByName("FX_hudun"), this.owner);
        Tx.transform.position = this.owner.transform.position;
    ...
    onTriggerEnter(other) {
        ...
        if (oname.indexOf("ziDan") != -1) {
            if (obj.getComponent(ziDan_1.default).zhuRen.zhenYing == 1) {
                if (this.wt == null || this.wt == undefined) {
                }
                else {
                    obj.name = "xxx";
                    obj.active = false;
                    this.shouJi(obj.getComponent(ziDan_1.default).zhuRen.gongJiLi);
                }
            }
        }
        //撞到石柱
        if (oname.indexOf("ShiZhu") != -1) {
            ...
            obj.active = false;
            // obj.destroy();
            this.shouJi(parseInt(GameManager_1.default.jsonShuJv["shiTiouDeShangHai"]));
        }
    }
}
exports.default = CwControl;
