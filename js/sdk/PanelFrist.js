...
class PanelFrist extends Laya.Scene {
    constructor() {
        super();
    }
    onEnable() {
...
*/
        ...
        Laya.loader.load("shuJv.json", Laya.Handler.create(this, function () {
            GameManager_1.default.jsonShuJv = Laya.loader.getRes("shuJv.json");
    ...
    LoadConfig() {
        ...
        //     this.LoadModels();
        // }));
        PlayerData_1.default.GetData();
        this.LoadModels();
    }
    LoadModels() {
        this.loadValue = 1;
        Laya.loader.create("res/Scene/Conventional/Model.lh", Laya.Handler.create(this, function () {
            GameManager_1.default.models = Laya.loader.getRes("res/Scene/Conventional/Model.lh");
            if (GameManager_1.default.models) {
                this.StartGame();
            }
            else {
                this.LoadModels();
