...
export default class AD {
    ...
    static showChaPing(obj)  //0是主界面 1是游戏界面 2是暂停或结算 3是弹窗 4是选关界面 5皮肤弹窗
    {
        switch(AD.chanelName)
        {
            case "web":
            ...
            case "huawei":
                if(obj == 2)
                {
                    ...
                    GxGame.Ad().showNativeInterstitial(()=>{},()=>{},0);
                }
                break;
            case "233":
                if(obj == 2)
            ...
            case "oppo":
                ...
                else
                {
                    ...
                    GxGame.Ad().showOtherNativeInterstitial(()=>{},()=>{},0);
                }
                break;
            case "qq":
            case "wx":
    ...
    static hideChaPing()
    {
        switch(AD.chanelName)
        {
            ...
            case "momoyu":
                console.warn("隐藏插屏");
                GxGame.Ad().hideNativeInterstitial();
                break;
        }
    }
    ...
    static share(success)
    {
        switch(AD.chanelName)
        {
            ...
            case "tt":
                console.warn("头条分享");
                GxGame.Ad().shareRecorder(success);
                break;
            case "ks":
                console.warn("快手分享");
    ...
    static getData() 
    {
        let item = PlayerData.GetUserData(AD.saveName)
