...
class jiangShi extends Laya.Script3D {
    constructor() {
        super();
    }
    onEnable() {
    ...
    xunLuoFun(dian1, dian2) {
        ...
        for (var i = 0; i < this.owner.numChildren; i++) {
            var wt = this.owner.getChildAt(i).getComponent(jiao_1.default).wt;
            ...
            this.owner.getChildAt(i).getComponent(jiao_1.default).xunLuoFun();
        }
        this.state = "xunLuo";
    }
    //巡逻待机
    ...
    AutoMove() {
        ...
        //巡逻
            ...
            var jvLi = Laya.Vector3.distance(this.owner.transform.position, GameManager_1.default.curPlayerControl.owner.transform.position);
            if (jvLi <= 0.3) {
                ...
                //坚守据点模式
                if (GameManager_1.default.curLevelManager.moShi == "jvDianZhanLing" || GameManager_1.default.curLevelManager.moShi == "xiaoDaoZuiHou") {
                    //判断敌人是否都消灭了
